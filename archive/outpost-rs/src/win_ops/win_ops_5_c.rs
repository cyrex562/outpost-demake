...
//    uVar12 = (param_1 >> 0x10);
    ...
    puVar7                      = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2d, unaff_SS, puVar5, unaff_DI);
    uVar9                       = (puVar7 >> 0x10);
    (iVar11 + 0xf2)             = puVar7;
    (iVar11 + 0xf4)             = uVar9;
    ...
    *(HANDLE16 *)(iVar11 + 0xc2) = uVar3;
    ...
    puVar7          = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2f, unaff_SS, puVar6, unaff_DI);
...
pub fn pass1_1008_3bd6(param_1: u32,
