...

{
    ...
    {
        hwnd   = SEG_1010;
        puVar6 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x3, param_4, (LVar5 >> 0x10), param_2);
...

{
    ...
    UVar10 = (u32)param_1;
    uVar8  = (param_1 >> 0x10);
    dialog_ui_fn_1040_78e2(param_1, SEG_1008);
...
// LAB_1040_88a5:
    ...
    puVar6       = mixed_1010_20ba(globals.dat_1050_0ed0, 0x48, param_2, extraout_DX, unaff_DI);
    uVar5        = (puVar6 >> 0x10);
    ...
    if((UVar10 + 0xb2) != 0x0)
    {
        puVar6 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x37, param_2, puVar4, unaff_DI);
...
pub fn pass1_1040_89a4(Globals    *globals,
                    param_1: *mut u32,
                    param_2: *mut u16,
                     u8         *param_3,
                     param_4: i16,
...

{
    ...
    u_var2  = *param_2;
    uVar6  = SEG_1010;
    puVar7 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2, param_5, param_3, param_4);
    uVar5  = (puVar7 >> 0x10);
    uVar4  = puVar7;
    if((uVar4 + 0x72) != 0x0)
    {
    ...
    if (param_1.field_0x0 == 0x4) {
        ...
        if ((HVar4 | HVar5) != 0x0) {
            ...
            if(iVar2 == 0x4)
            {
                ...
                (**ppcVar3)(LAST_SEGMENT, HVar5, HVar4, (iVar6 + 0x8) & 0x10, uVar1);
                return;
            }
        }
    }
...

{
    ...
    let mut bool_1: BOOL16;
    let mut local_1a: [RECT16;0x2] = [0;0x2]
...

{
    ...
    let mut lp_help_file: *mut c_char;
    let mut w_command: u16;
    let mut uVar3: u16;

    p_var2 = unk_io_op_1010_830a(globals.dat_1050_14cc, 0x1f8, param_2);
    uVar1  = (param_1 >> 0x10);
    if((param_1 + 0x8a) == 0x0)
    {
        w_command    = 0x0;
...

{
    ...
    let mut uVar11: u16;
    let mut uVar12: u16;
    let mut iVar11: *mut Struct443;
    let mut unaff_DI: i16;
    let mut uVar13: u16;
    let mut uVar14: u16;
    let mut puVar15: *mut u16;
    let mut BVar16: BOOL16;

    dialog_ui_fn_1040_78e2(param_1, param_2);
    puVar15                              = mixed_1010_20ba(globals.dat_1050_0ed0, 0x41, param_3, param_4, unaff_DI);
    uVar14                               = (puVar15 >> 0x10);
    paVar5                               = puVar15;
    uVar13                               = (param_1 >> 0x10);
    iVar11                               = param_1;
    ...
    puVar15 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x3, param_3, puVar9, unaff_DI);
    uVar11  = (puVar15 >> 0x10);
    uVar3   = puVar15;
    uVar12  = uVar11;
    ...
    if(param_4 != 0x10c)
    {
        ...
        else
        {
            if(param_4 != 0x10d)
            {
                if(param_4 == 0x10e)
                {
                    puVar8 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x32, param_6, in_DX, unaff_DI);
                    iVar3  = puVar8;
...

{
    ...
    ppcVar1 = (*param_1 + 0x74);
    (**ppcVar1)();
    puVar4 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x3, unaff_SS, extraout_DX, unaff_DI);
    u_var2  = (param_1 + 0x90);
...

{
    ...
    while(true)
    {
        ...
        paVar7 = pass1_1018_3a7a(*(param_1 + 0x96), uVar3 & 0xffff | extraout_DX_00 << 0x10, uVar3, extraout_DX_00);
        uVar4  = param_3;
...

{
    ...
    else
    {
        ...
        else
        {
            ...
            puVar4 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x32, param_8, param_5, param_6);
            iVar3  = puVar4;
            uVar1  = (param_1 + 0x92);
...

{
    ...
    if((param_1 + 0x92) != 0x0)
    {
        u_var2   = (param_1 + 0x8e);
        uVar1   = (u_var2 + 0xa);
        puVar5  = mixed_1010_20ba(globals.dat_1050_0ed0, 0x3, param_6, param_3, param_4);
        u_var2   = (param_1 + 0x92);
        uVar4   = (u_var2 >> 0x10);
        iVar3   = u_var2;
        param_5 = SEG_1010;
...

{
    ...
    for(uStack18 = 0x0; uStack18 < local_4; uStack18 = uStack18 + 0x1)
    {
        ...
        uVar11 = 0x403;
        u_var2  = (param_1 + 0x8e);
        paVar8 = string_1010_5286(u_var2, (u_var2 >> 0x10), uVar1, uVar1, puVar5);
