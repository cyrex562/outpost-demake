...

{
    ...
    if(param_3 != 0x1c8)
    {
        if(param_3 == 0x1c9)
        {
            puVar7 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2f, unaff_SS, in_DX, unaff_DI);
            u_var2  = (puVar7 >> 0x10);
            uVar1  = (puVar7 + 0x20);
            uVar5  = (puVar7 + 0x22);
            uVar3  = uVar5 | uVar1;
            ...
            puVar7 = mixed_1010_20ba(globals.dat_1050_0ed0, uVar4, unaff_SS, puVar6, unaff_DI);
            if(puVar7 == 0x0)
            {
                return;
            }
...

{
    ...
    let mut paStack14: *mut Struct43;
                ...
                if(param_4 != 0x123)
                {
                    ...
                    else
                    {
                        if(param_4 == 0x126)
                        {
                            ...
                            paStack14     = unk_io_op_1010_830a(globals.dat_1050_14cc, 0x1f8, param_5);
...
// LAB_1038_dac3:
    ...
    puVar3 = 0x0;
// LAB_1038_dc37:
    paStack14 = str_var1(puVar3, iVar7);
    if(uStack8 == 0x0)
    {
...

{
    ...
    if(iStack12 == 0x6)
    {
        ...
        iVar3    = 0x0;
        uVar5    = 0x0;
        local_18 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x37, param_4, extraout_DX, unaff_DI);
...

{
    ...
    if(param_3 == 0x1c4)
    {
        puVar10 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2f, param_6, param_4, param_5);
        uVar14  = (puVar10 >> 0x10);
        uVar4   = (puVar10 + 0x24);
        uVar5   = (puVar10 + 0x26);
        uVar3   = uVar5 | uVar4;
        if(uVar3 != 0x0)
        {
            ...
            if((uVar5 | uVar3) != 0x0)
            {
                ...
                else
                {
                    ...
                    puVar10 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x32, param_6, puVar7, (u_var2 >> 0x10));
    ...
    else
    {
        ...
        uVar12  = 0x0;
        uVar13  = 0x0;
        puVar10 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x32, param_6, param_4, param_5);
...
{
    let mut iVar1: *mut Struct70;
    let mut uVar1: *mut Struct70;
...

{
    ...
    while(true)
    {
        ...
        uVar1  = (param_1 + 0x8e);
        paVar8 = string_1008_e586(uVar1, (uVar1 >> 0x10), uVar4 & 0xffff | extraout_DX_00 << 0x10, uVar4, extraout_DX_00);
        uVar5  = param_3;
...

{
    ...
    let mut local_10: BOOL16;
    let mut puStack14: *mut u32;
    let mut puStack10: *mut u16;
    let mut pu_stack6: *mut u16;

    pu_stack6  = mixed_1010_20ba(globals.dat_1050_0ed0, 0x8, param_2, in_DX, unaff_DI);
    puStack10 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x9, param_2, (pu_stack6 >> 0x10), unaff_DI);
...

{
    ...
    let mut iVar5: i16;
    let mut uVar6: u16;
    let mut iVar7: *mut Struct51;
    let mut uVar7: *mut Struct51;
...

{
    ...
    if((iVar1 + 0x214) == 0x0)
    {
        ...
        paVar3 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x37, unaff_SS, in_DX, unaff_DI);
...

{
    ...
    let mut iStack12: i16;
    let mut uStack10: u32;
    let mut paStack6: *mut Struct67;

    paStack6 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x37, param_7, param_5, param_6);
...

{
    ...
    p_var2 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x37, param_4, param_2, param_3);
...

{
    ...
    if((param_3 | uVar4) == 0x0)
    {
        ...
        puVar8   = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2b, param_4, 0x0, param_5);
        ...
        iStack30 = 0x0;
        uStack26 = 0x0;
        pass1_1028_dc52(CONCAT13((param_4 >> 0x8), CONCAT12(param_4, local_30)), 0x1, 0x0, 0x400);
        while(true)
        {
            pu_var2 = local_30;
        ...
        if(iStack30 == 0x0)
        {
            ...
            iVar6  = 0x0;
            uVar7  = 0x0;
            paVar9 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x37, param_4, 0x0, param_5);
...

{
    ...
    if((uStack16 | uStack18) != 0x0)
    {
        ...
        {
            puVar15 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x37, param_6, puVar13, iVar12);
            puVar13 = (puVar15 >> 0x10);
            post_win_msg_1008_a0e4((puVar15 & 0xffff | ZEXT24(puVar13) << 0x10), 0x0, uStack18, (iVar11 + 0x208), *(iVar11 + 0x4), 0x2, SEG_1008, param_6);
            puVar15 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2b, param_6, puVar13, iVar12);
...

{
    ...
    iVar4  = 0x0;
    u_var2  = 0x0;
    paVar1 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x37, param_4, param_2, param_3);
...

{
    ...
    paVar4 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x37, param_4, param_2, param_3);
    uVar3  = param_1;
    iVar10 = (uVar3 + 0x108);
    if(iVar10 - 0x1U < 0x8)
    {
        ...
        0x7 =>
            ...
            iVar10 = 0x7;
            puVar5 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2f, param_4, pu_var2, param_3);
            uVar1  = (puVar5 >> 0x10);
            uVar3  = puVar5;
...

{
    ...
    puVar3   = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2c, unaff_SS, in_DX, unaff_DI);
    u_var2    = (puVar3 >> 0x10);
    lVar1    = (puVar3 + 0xc);
    uStack8  = (lVar1 >> 0x10);
    uStack10 = lVar1;
...

{
    ...
    let mut paStack38: *mut Struct67;
    ...
    uVar13 = (param_4 >> 0x8);
    pass1_1028_dc52(CONCAT13(uVar13, CONCAT12(param_4, local_14)), 0x1, 0x0, 0x400);
    iStack26 = 0x1;
    iStack28 = 0x0;
    do
    {
...
// LAB_1028_7066:
    ...
    if(iStack30 == 0x0)
    {
        ...
        if(puStack32 != 0x0)
        {
            ...
            uVar16             = 0x0;
            iVar11             = 0x1;
            uStack52           = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2b, param_4, puStack32, param_3);
    ...
    if((iStack28 != 0x0) && (iStack26 != 0x0))
    {
        ...
        iVar11    = 0x0;
        uVar9     = 0x0;
        uStack52  = mixed_1010_20ba(globals.dat_1050_0ed0, 0x37, param_4, puStack32, param_3);
        puStack32 = (uStack52 >> 0x10);
        pu_var2    = uStack52;
            ...
            pu_var2 == 0x0 && ((pu_var2 = pass1_1030_2242(str_var1(puStack32, puStack34), 0x3c), pu_var2 == 0x0 && (pu_var2 = pass1_1030_2242(str_var1(puStack32, puStack34), 0x3d), pu_var2 == 0x0))))))
    {
        ...
        do
        {
            ...
            {
                uStack52 = str_var1(uStack52, 0x1);
            }
        ...
        iVar11    = 0x0;
        uVar9     = 0x0;
        paStack38 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x37, param_4, puVar4, param_3);
...
// LAB_1028_72d3:
    ...
    {
        puVar8    = mixed_1010_20ba(globals.dat_1050_0ed0, 0x3b, param_4, (puVar4 | pu_var2), param_3);
        puVar4    = (puVar8 >> 0x10);
        iStack48  = puVar8;
        puStack46 = puVar4;
        pass1_1008_df4a(puVar8, param_3, param_4);
        puVar8    = mixed_1010_20ba(globals.dat_1050_0ed0, 0x3c, param_4, puVar4, param_3);
        uVar7     = (puVar8 >> 0x10);
        iStack48  = puVar8;
        puStack46 = uVar7;
        pass1_1018_34a6(puVar8);
        pass1_1028_dc52(CONCAT13(uVar13, CONCAT12(param_4, local_46)), 0x1, 0x0, 0x400);
        while(true)
        {
            uVar6  = uVar7;
            pu_var2 = local_46;
            pass1_1028_e4ec(str_var1(param_4, pu_var2));
            uStack52 = str_var1(uVar6, pu_var2);
            uVar7    = uVar6 | pu_var2;
            if(uVar7 == 0x0)
                break;
            if((pu_var2 + 0x200) != 0x8000002)
...
//    i16          iVar11;
    ...
    create_window_ex_1008_9760(param_1, SEG_1008);
    puVar13                     = mixed_1010_20ba(globals.dat_1050_0ed0, 0x4, unaff_SS, in_DX, unaff_DI);
    uVar7                       = (puVar13 >> 0x10);
//    uVar12                      = (param_1 >> 0x10);
//    iVar11                      = param_1;
...

{
    ...
    pu_stack6  = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2, param_2, in_DX, unaff_DI);
    puVar3    = (pu_stack6 >> 0x10);
    iStack8   = (pu_stack6 + 0x20);
    puStack12 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x37, param_2, puVar3, unaff_DI);
    ...
    if(local_10e == 0x6)
    {
        ...
        hwnd_00         = SEG_1010;
        puVar5          = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2, param_2, puVar3, unaff_DI);
        puVar3          = (puVar5 >> 0x10);
        (puVar5 + 0x20) = 0x1;
    }
    if(local_10e == 0x15)
...

{
    ...
    long         lVar8;
    let mut uVar9: u16;
    let mut iVar9: *mut Struct282;

    iVar9 = param_1;
    uVar9 = (param_1 >> 0x10);
    create_window_ex_1008_9760(param_1, SEG_1008);
    get_dc_1018_4db0(iVar9.field_0xfa, iVar9.field_0x8, SEG_1018);
    puVar7                      = mixed_1010_20ba(globals.dat_1050_0ed0, 0x32, param_3, param_2, unaff_DI);
...

{
    ...
    iVar3 = (param_4 >> 0x10);
    post_win_msg_1020_79fc(str_var1(param_2, param_1), param_3, param_4, iVar3, param_7);
    pu_var2 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x29, unaff_SS, param_6, unaff_DI);
    puVar1 = (pu_var2 >> 0x10);
    if(iVar3 == 0x0)
    {
...
{
    let mut BVar1: BOOL16;
    let mut iVar2: *mut Struct63;
    let mut u_var2: *mut Struct63;
...

{
    ...
    if(param_2 == 0xfb)
    {
        puVar5 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x30, param_3, in_DX, unaff_DI);
    ...
    else
    {
        ...
        if(cVar2 == 'o')
        {
            paVar7 = unk_io_op_1010_830a(globals.dat_1050_14cc, 0x1f8, param_3);
