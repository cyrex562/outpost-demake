...
pub unsafe fn draw_op_1038_9dcc(globals: &mut Globals,
...
pub unsafe fn call_fn_ptr_1038_9ffa(win_handle: HWND16, param_2: u16, struct_1: *mut Struct733, param_4: u16) -> u16
...
pub unsafe fn draw_op_1038_92f6(param_1: u16, param_2: u16, param_3: u16, param_4: u32, param_5: HWND16, param_6: u16)

{
    ...
    if(param_4 == 0xeb)
    {
        paStack6 = mixed_1010_20ba(
          NULL, globals.dat_1050_0ed0, 0x3, param_6, in_DX, unaff_DI);
