...

{
    ...
    if(param_2 != 0x129)
    {
        ...
        if(param_2 == 0xfb)
        {
            puVar6 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x30, param_4, in_DX, unaff_DI);
        ...
        if(param_2 < 0xfc)
        {
            ...
            if(cVar2 == 'r')
            {
                ...
                puVar6 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x30, param_4, in_DX, unaff_DI);
                uVar4  = (puVar6 >> 0x10);
                pass1_1010_3770(puVar6, str_var1(uVar10, iVar3), uVar4);
                pass1_1038_af40(globals.ptr_1050_5b7c, (uVar5 + 0x8), 0x3, uVar4, uVar5, SEG_1038, param_4);
                return;
            }
            if(cVar2 == 'u')
            {
...
pub fn pass1_1020_1022(param_1: u32, HANDLE16 param_2)
...
//    iVar5    = param_1;
    ...
    if(BVar3 == 0x0)
    {
        ...
        if((uVar4 | uVar7) != 0x0)
        {
            uVar1 = *(param_1 + 0x14);
            hwnd  = SEG_1008;
            pass1_1008_4480(*(param_1 + 0x18), (uVar1 & 0xffff0000 | (uVar1 + 0x76)), (uVar7 & 0xffff | uVar4 << 0x10), unaff_SS);
        }
...

{
    ...
    if(globals.PTR_LOOP_1050_0010 == 0x0)
    {
        ...
        if(iStack4 != 0x0)
        {
            ...
            iStack18 = iStack20;
            iStack16 = iStack22;
            FillRect16(LAST_SEGMENT, pRStack6, (HBRUSH16)&local_1a);
...

{
    ...
    puVar3                = mixed_1010_20ba(
      globals.dat_1050_0ed0, 0xa, param_1, extraout_DX, unaff_DI);
    uVar1                         = (puVar3 >> 0x10);
...

{
    ...
    puVar5                     = mixed_1010_20ba(globals.dat_1050_0ed0, 0xa, param_5, extraout_DX, param_4);
    uVar4                      = (puVar5 >> 0x10);
...
//    uVar7 = (param_1 >> 0x10);
    ...
    puVar6                     = mixed_1010_20ba(globals.dat_1050_0ed0, 0x28, param_4, extraout_DX, unaff_DI);
    puVar4                     = (puVar6 >> 0x10);
    param_1.field_0xf2          = puVar6;
    param_1.field_0xf4          = puVar4;
    param_1.field_0xe6          = param_1.field_0xf2;
    param_1.field_0xe8          = puVar4;
    puVar6                     = mixed_1010_20ba(globals.dat_1050_0ed0, 0x32, param_4, puVar4, unaff_DI);
...

{
    ...
    puVar6                       = mixed_1010_20ba(globals.dat_1050_0ed0, 0x28, param_4, (puVar6 >> 0x10), param_2);
    uVar4                        = (puVar6 >> 0x10);
    ...
    puVar6 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x48, param_4, puVar5, param_2);
...
pub fn pass1_1018_ed98(u16 *param_1, param_2: u16)
...

{
    ...
    hwnd = SEG_1008;
    pass1_1008_4480(puStack38, (param_1 & 0xffff0000 | (iVar5 + 0x18U)), (iVar5 + 0x24), param_3);
    paStack46 = 0x0;
...

{
    ...
    if(0x280 < (iVar3 + 0xa))
    {
        ...
        FillRect16(LAST_SEGMENT, local_rect_1, (HBRUSH16)&local_brush_handle);
        DeleteObject16(LAST_SEGMENT);
    }
    u_var2     = (iVar3 + 0x6);
    ...
    pHStack42 = (HDC16 *)SelectPalette16(LAST_SEGMENT, 0x0, pHStack42);
    DeleteObject16(LAST_SEGMENT);
    EndPaint16(LAST_SEGMENT, &local_22);
    return;
}
...
pub fn pass1_1018_dfd4(param_1: u32, param_2: *mut u8, param_3: i16, param_4: u16, param_5: u16)

{
    ...
    {
        (uVar1 + 0xe6) = 0x1;
        puVar3         = mixed_1010_20ba(globals.dat_1050_0ed0, 0x36, param_5, param_2, param_3);
...

{
    ...
    puVar3             = mixed_1010_20ba(globals.dat_1050_0ed0, 0x26, param_1, extraout_DX, unaff_DI);
    uVar1              = (puVar3 >> 0x10);
...
pub fn pass1_1018_e4f2(param_1: *mut Struct659, param_2: u16, param_3: u16, param_4: i16, param_5: u16)

{
    ...
    param_1.field_0x2         = SEG_1018;
    puVar5                     = mixed_1010_20ba(globals.dat_1050_0ed0, 0x26, param_5, extraout_DX, param_4);
    uVar4                      = (puVar5 >> 0x10);
    param_1.field_0x14        = puVar5;
    param_1.field_0x16        = uVar4;
    param_1.field_0x6         = param_1.field_0x14;
...
pub fn pass1_1018_e57a(u16 *param_1) {
...
pub fn unk_draw_op_1018_c578(param_1: *mut Struct36, param_2: u16)

{
    ...
    hwnd      = SEG_1010;
    puStack38 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2, param_2, in_DX, unaff_DI);
...

{
    ...
    param_1.field_0x2         = SEG_1018;
    pu_stack6                   = mixed_1010_20ba(globals.dat_1050_0ed0, 0x48, param_4, (puVar11 >> 0x10), unaff_DI);
    ...
    puVar11                      = mixed_1010_20ba(globals.dat_1050_0ed0, 0x27, param_4, puVar7, unaff_DI);
    uVar8                        = (puVar11 >> 0x10);
    ...
    {
        pass1_1008_50c2(str_var1(puVar7, uVar5), *(uVar4 + 0x8), *(uVar4 + 0x4),
...
pub fn unk_draw_op_1018_623e(param_1: u32, param_2: HWND16, param_3: u16)

{
    ...
    *(HPEN16 *)(puVar13 + -0x3a)    = handle;
    ...
    DeleteObject16(LAST_SEGMENT);
    EndPaint16(LAST_SEGMENT, (PAINTSTRUCT16 *)(puVar13 + -0x20));
    return;
}
...
void struct_1018_66cc(param_1: &mut Struct20, param_2: u16, param_3: u16, param_4: u16)
...
//    iVar2                                    = param_1;
    ...
    pu_var2                                   = mixed_1010_20ba(globals.dat_1050_0ed0, 0xb, param_4, extraout_DX, unaff_DI);
    uVar1                                    = (pu_var2 >> 0x10);
...
pub fn pass1_1018_6924(param_1: *mut Struct658, param_2: u16, param_3: u16, param_4: i16, param_5: u16)

{
    ...
    param_1.field_0x2         = SEG_1018;
    puVar5                     = mixed_1010_20ba(globals.dat_1050_0ed0, 0xb, param_5, extraout_DX, param_4);
    uVar4                      = (puVar5 >> 0x10);
    param_1.field_0x14        = puVar5;
    param_1.field_0x16        = uVar4;
    param_1.field_0x6         = param_1.field_0x14;
...
pub fn pass1_1018_69ac(u16 *param_1) {
...

{
    ...
    BeginPaint16(param_2, &local_22);
    EndPaint16(LAST_SEGMENT, &local_22);
    puVar1 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2, unaff_SS, in_DX, unaff_DI);
    if((puVar1 + 0x20) == 0x0)
    {
...

{
    ...
    (**ppcVar1)();
    uVar4 = pass1_1008_4772(param_1.field_0xa);
    pass1_1008_43cc(param_1.field_0xa);
    p_var2            = CreateDC16(SEG_1008, uVar4, (uVar4 >> 0x10), (DEVMODEA *)0x0);
...
//    iVar2              = param_1;
    ...
    param_1.field_0xe4  = SEG_1018;
    puVar3             = mixed_1010_20ba(globals.dat_1050_0ed0, 0x27, param_4, extraout_DX, unaff_DI);
    uVar1              = (puVar3 >> 0x10);
...

{
    ...
    do
    {
        draw_op_1010_47d0((u32)param_1, (param_1 >> 0x10), UStack4, param_2, param_3);
        UStack4 = UStack4 + 0x1;
    } while(UStack4 < 0x10);
    return;
}
...

{
    ...
    iVar4 = param_3 + 0x105;
    pass1_1010_8170globals.dat_1050_14cc, iVar4, puVar6, LAST_SEGMENT);
    iVar7                    = param_3 * 0x4;
...

{
    ...
    PStack8        = (POINT16)str_var1(param_2, param_3);
    uVar5          = (param_1 >> 0x10);
    iVar4          = param_1;
...

{
    ...
    do
    {
        ...
        // LAB_1010_413e:
            ...
            {
                puVar10 = mixed_1010_20ba(globals.dat_1050_0ed0, iStack6 + 0xcU, unaff_SS, in_DX, unaff_DI);
                puVar7  = (puVar10 >> 0x10);
                ...
                if(uVar4 == 0x0)
                {
                    ...
                    else
                    {
                        ...
                        iVar6 = string_1040_8520(str_var1(puVar7, uVar5), globals.PTR_LOOP_1050_0396, 0x30, 0x2, 0x643, 0x645, puVar8, unaff_SS);
                    }
                    puStack16 = str_var1(puVar8, iVar6);
                    ppcVar2   = (*puStack16 + 0x74);
                    (**ppcVar2)(uVar9, iVar6, puVar8);
                    pass1_1010_209e(globals.dat_1050_0ed0, iStack6 + 0xcU);
                    uStack4 = uVar4;
                }
            }
            if(uStack4 != 0x0)
...

{
    ...
    0x7 =>
        ...
        puVar17 = extraout_DX;
        pass1_1010_8170globals.dat_1050_14cc, iVar15, extraout_DX, SEG_1010);
        iVar19                                   = param_5 * 0x4;
    ...
    0xd =>
        ...
        *pi_var1        = 0x509a//s_SCi16ernalPutBldg2_site_0x_08lx__1050_5099 + 0x1;
        ...
        return CONCAT11((undefined)param_1, u_var28);
    0xe =>
    ...
    0x13 =>
        ...
        if((((iVar15 + 0x22) != 0x0) || ((iVar15 + 0x24) != 0x0)) || (((iVar15 + 0x26) != 0x0 || ((iVar15 + 0x28) != 0x0))))
        {
            ...
            uVar4    = (param_1 + 0xa);
            HStack30 = 0x62a0;
            WritePrivateProfileString16(SEG_1000, uVar4, (uVar4 >> 0x10),  * (param_1 + 0xe));
        }
        return param_7;
    0x14 =>
    ...
    0x19 =>
        ...
        if(uVar13 != 0x0)
        {
            ...
            pass1_1010_715c(
              str_var1(0x1a, puVar10), 0x1a, uVar13, param_7, unaff_DI, unaff_SS);
        }
        if(param_5 == 0x2c)
        {
            pass1_1010_715c(str_var1(0x1d, __return_storage_ptr__), 0x1d, uVar13, param_7, unaff_DI, unaff_SS);
        }
