...
pub unsafe fn unk_draw_op_1018_cda8(globals: &mut Globals, param_1: *mut Struct36, param_2: u16)

{
    ...
    hwnd = SEG_1010;
    puStack38
      = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2, param_2, in_DX, unaff_DI);
...
pub unsafe fn unk_draw_op_1018_cfc0(globals: &mut Globals, param_1: *mut Struct36, param_2: u16)
...

{
    ...
    do
    {
        ...
        MoveToEx16(
          LAST_SEGMENT, local_38, param_3, *(POINT16 **)(iVar3 + puStack26));
...
//    iVar2              = param_2;
    ...
    puVar3 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x25, param_1, extraout_DX, unaff_DI);
    uVar1  = (puVar3 >> 0x10);
...
pub fn pass1_1020_7824(Globals   *globals,
                     param_1: *mut Struct7,
                     param_3: u16,
                     param_4: i16,
                    param_5: u16)

{
    ...
    param_1.field_0x2         = SEG_1020;
    puVar5 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x25, param_5, extraout_DX, param_4);
    uVar4  = (puVar5 >> 0x10);
...

{
    ...
    if((is_iconic == 0x0) || (globals.PTR_LOOP_1050_0010 != 0x0))
    {
        ...
        (**ppcVar1)(LAST_SEGMENT, pu_var2, (iVar3 + 0xe2), 0x0, uVar9, HVar10, uVar11);
        ...
        (**ppcVar1)(LAST_SEGMENT, iVar4.field_0x6, uVar7, uVar8);
        if(*count != '\0')
        {
...

{
    ...
    HVar3                       = LoadCursor16((HINSTANCE16)LAST_SEGMENT, 0x7f00);
    param_1.hcursor_field_0xc4 = HVar3;
    param_1.field_0xc8         = 0x2028;
    param_1.field_0xac         = 0x47000000;
    param_1.field_0xbc         = (param_3 + 0x8);
    puVar7
      = mixed_1010_20ba(globals.dat_1050_0ed0, 0x48, unaff_SS, puVar4, unaff_DI);
    uVar1               = (puVar7 >> 0x10);
...

{
    ...
    if(param_2 != 0x0)
    {
        ...
        while(true)
        {
            ...
            puVar4  = (puVar3 + 0x4);
            ppcVar1 = (*puVar4 + 0x90);
            (**ppcVar1)(SEG_1008, puVar4, uVar9, 0x1, uVar8);
        }
    }
    return;
}
...
pub fn pass1_1020_6466(u16 *param_1, param_2: u16, param_3: u16)
...

{
    ...
    PStack6 = (POINT16)str_var1(param_2, param_3);
    uVar5   = (param_1 >> 0x10);
    ...
    if(u_var2 != 0x0)
    {
        ...
        if(BVar3 != 0x0)
        {
            ...
            (**ppcVar1)(LAST_SEGMENT, param_1, 0xef, uVar4);
        }
    }
    return;
}
...

{
    ...
    if(BVar4 == 0x0)
    {
        ...
        (**ppcVar2)(SEG_1008, local_brush_handle, (local_brush_handle >> 0x10), 0x0, 0x0);
        ppcVar2 = ((iVar8 + 0x18) + 0x94);
        (**ppcVar2)(SEG_1008, (iVar8 + 0x18), 0x1);
    ...
    else
    {
        if(globals.PTR_LOOP_1050_0010 == 0x0)
        {
            ...
            (**ppcVar2)(LAST_SEGMENT, (iVar8 + 0x1c), uVar10, uVar11);
            BStack38 = BVar4;
            if(BVar4 != 0x0)
            {
...

{
    ...
    (iVar8 + 0x2)      = SEG_1020;
    puVar10        = mixed_1010_20ba(globals.dat_1050_0ed0, 0x6, unaff_SS, in_DX, unaff_DI);
    uVar7          = (puVar10 >> 0x10);
    (iVar8 + 0x14) = puVar10;
    (iVar8 + 0x16) = uVar7;
    ppcVar2        = ((iVar8 + 0x14) + 0x4);
    (**ppcVar2)(SEG_1010, (iVar8 + 0x14), uVar7, 0x0, param_1);
    ...
    *(i16 *)(iVar8 + 0x1e)       = iVar4;
    ...
    pHVar6                       = &local_4;
    ppcVar2                      = (*puVar1 + 0x8);
    (**ppcVar2)(LAST_SEGMENT, puVar1, (puVar1 >> 0x10), pHVar6);
...
//    u16       uVar7;
    ...
    HINSTANCE16 hinst_var9;
    HINSTANCE16 hinst_var10;
    let mut puVar11: u16;
...
//    uVar5              = param_1;
    ...
    cursor_handle_1   = LoadCursor16((HINSTANCE16)LAST_SEGMENT,
    ...
    puVar8
      = mixed_1010_20ba(globals.dat_1050_0ed0, 0x29, unaff_SS, puVar4, unaff_DI);
...
void destroy_cursor_1020_42f4(u16 *param_1, HMENparam_2: u16) {
    ...
    DestroyCursor16((HCURSOR16)LAST_SEGMENT);
...

{
    ...
    (iVar6 + 0x2) = SEG_1020;
    puVar8
            = mixed_1010_20ba(globals.dat_1050_0ed0, (param_2 + 0xfc), unaff_SS, in_DX, unaff_DI);
    (iVar6 + 0x14) = puVar8;
...

{
    ...
    if(BVar3 == 0x0)
    {
        ...
        (**ppcVar1)(SEG_1018, local_3c, (local_3c >> 0x10), 0x0, 0x0, 0xdc, param_3);
        u_var2 = (iVar4 + 0x14);
        if((u_var2 + 0x84) != 0x1)
        {
            unk_draw_op_1020_320e(param_1, local_24, param_3);
        ...
        (**ppcVar1)(SEG_1018, local_3c, (local_3c >> 0x10), &local_24, param_3);
    }
    else
    {
        if(globals.PTR_LOOP_1050_0010 == 0x0)
...

{
    ...
    if((uVar3 + 0x84) == 0x1)
    {
        ...
        pHStack6 = &local_4;
        ppcVar2  = (*puVar1 + 0x8);
        (**ppcVar2)(LAST_SEGMENT, puVar1, (puVar1 >> 0x10), pHStack6, param_3);
    }
    pass1_1018_0d9a(
            ...
            *pbVar2  = *pbVar2 | bVar12;
            ...
            code_rSEG_10203d96:
                ...
                *pbVar2 = *pbVar2 & (u8)pu_var24;
                ...
                pu_var24
                  = (u_var21
                     | (u8)((pu_var24 >> 0x8) * '\x02' + ((u8)u_var20 < 0x20)) << 0x8);
            ...
            code_rSEG_10203db1:
                ...
                *puVar6         = addr_table_1020_408a;//0x408a;
                (puVar6 + 0x2)  = SEG_1020;
                puVar32
                  = mixed_1010_20ba(globals.dat_1050_0ed0, 0x6, param_9, pu_var24, pcVar27);
...

{
    ...
    (**ppcVar1)(SEG_1010, puStack40, (puStack40 >> 0x10), pHVar5, param_3, uVar16);
    *(HDC16 **)(iVar12 + 0x10) = pHVar5;
    ...
    puVar3  = (puVar14 + -0x26);
    ppcVar1 = (*puVar3 + 0x4);
    (**ppcVar1)(SEG_1008, puVar3, (puVar3 >> 0x10), 0x0, 0x0, puVar14 + -0x22, param_3);
    uVar11                          = extraout_DX;
...
pub fn pass1_1020_239c(param_1: u32, i16 *param_2, param_3: u16)
...
void struct_1020_2524(param_1: &mut Struct20, param_2: u16, param_3: u16, param_4: u16)

{
    ...
    puVar3 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2a, param_4, extraout_DX, unaff_DI);
    uVar1  = (puVar3 >> 0x10);
...

{
    ...
    param_1.field_0x2         = SEG_1020;
    puVar5 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2a, param_5, extraout_DX, param_4);
    uVar4  = (puVar5 >> 0x10);
    param_1.field_0x14 = puVar5;
    param_1.field_0x16 = uVar4;
    param_1.field_0x6  = param_1.field_0x14;
...
pub fn pass1_1020_2838(u16 *param_1, param_2: u16) {
