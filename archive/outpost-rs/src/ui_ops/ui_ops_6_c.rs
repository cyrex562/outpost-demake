...

{
    ...
    if(uVar5.field_0xfa != 0x0)
    {
        ...
        pass1_1010_1ea6(uVar5.field_0xfa, str_var1(paVar4, uVar3), unaff_SS);
    }
...
void enable_window_1020_1bd4(globals: &mut Globals, param_1: i16, param_2: u16, param_3: u16, param_4: u32, param_5: HWND16)
...

{
    ...
    if(uVar5 != 0x0)
    {
        ...
        paStack10 = str_var1(extraout_DX, uVar5);
...
void win_ui_cursor_op_1020_1294(globals: &mut Globals, param_1: u32, param_2: i16, param_3: i16, param_4: u16, param_5: u16)

{
    ...
    if((param_4 | in_AX) == 0x0)
    {
        ...
        iVar4   = pt_in_rect_1010_40f8(*(iVar4 + 0xf2), (POINT16 *)str_var1(param_5, &local_6), SEG_1010);
        if(iVar4 != -0x1)
        {
            uVar6   = 0x0;
...

{
    ...
    puVar8             = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2d, param_3, (puVar8 >> 0x10), unaff_DI);
    puVar6             = (puVar8 >> 0x10);
    iVar5.field_0x14  = puVar8;
    &iVar5.field_0x16 = puVar6;
    pu_stack6           = mixed_1010_20ba(globals.dat_1050_0ed0, 0x29, param_3, puVar6, unaff_DI);
    ...
    *(HDC16 *)(uVar1 + 0x7c) = local_8;
    ...
    puVar6 = extraout_DX;
    pass1_1008_4d84((puVar5 & 0xffff | ZEXT24(extraout_DX) << 0x10), p_var2, extraout_DX);
...

{
    ...
    uVar4    = 0x89;
    pu_stack6 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x9, unaff_SS, in_DX, unaff_DI);
    ...
    puVar14         = mixed_1010_20ba(globals.dat_1050_0ed0, 0x39, unaff_SS, puVar7, unaff_DI);
    uVar12          = (puVar14 >> 0x10);
    uVar8           = puVar14;
    uVar11          = (param_1 >> 0x10);
    iVar9           = param_1;
    *(iVar9 + 0x8e) = uVar8;
    ...
    {
        pass1_1020_1eea(
          str_var1(puStack76, uVar8), param_1, (iVar9 + 0x6), puVar7, unaff_DI, unaff_SS);
        *(iVar9 + 0x92) = uVar8;
        (iVar9 + 0x94)  = puVar7;
    }
    uVar1     = *(iVar9 + 0x8e);
    pIStack12 = (uVar1 & 0xffff0000 | (uVar1 + 0xa));
    puStack16 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x48, unaff_SS, puVar7, unaff_DI);
    ...
    *pIStack12     = iVar10 / 0x2;
    pass1_1028_dc52(str_var1(unaff_SS, local_2e), 0x1, 0x0, 0x100);
    uStack56 = 0x0;
    while(true)
    {
        puVar6 = local_2e;
        pass1_1028_e4ec(str_var1(unaff_SS, puVar6));
    ...
    if((uVar4 == 0x0) || ((iVar9 + 0x96) != 0x0))
    {
        ...
        if(uStack8 != 0x0)
        {
            load_string_1010_84e0(SEG_1010, globals.dat_1050_14cc, globals.dat_1050_14cc >> 0x10,NULL), 0x100, local_178, (short)unaff_SS);
    ...
    {
        win_1008_5c7c(NULL, _PTR_LOOP_1050_02a0, 0x9d0001, unaff_SS, uVar4);
        (iVar9 + 0x8c) = uVar4;
    ...
    load_string_1010_84e0(SEG_1010, globals.dat_1050_14cc, globals.dat_1050_14cc >> 0x10,NULL), in_resc_id_3, in_buffer_4, (short)unaff_SS);
    SetWindowText16(SEG_1010, (SEGPTR)local_178);
// LAB_1020_1b24:
...
pub fn pass1_1018_5e5a(u16 *param_1) {
    let mut uVar1: u16;
...

{
    ...
    dialog_ui_fn_1040_78e2(NULL, param_1, SEG_1040);
    puVar11         = mixed_1010_20ba(globals.dat_1050_0ed0, 0x39, param_2, in_DX, unaff_DI);
    puVar5          = (puVar11 >> 0x10);
    uVar7           = puVar11;
    uVar10          = (param_1 >> 0x10);
    iVar9           = param_1;
    *(iVar9 + 0x8e) = uVar7;
    ...
    puVar11          = mixed_1010_20ba(globals.dat_1050_0ed0, 0x48, param_2, puVar6, unaff_DI);
...

{
    ...
    puVar7 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x48, unaff_SS, in_DX, unaff_DI);
    uVar4  = (puVar7 >> 0x10);
    iVar1  = (puVar7 + 0xa);
    iVar2  = (puVar7 + 0xc);
    uVar6  = (param_1 >> 0x10);
    ...
    paVar8 = unk_io_op_1010_830a(globals.dat_1050_14cc, (iVar5 + 0xec), unaff_SS);
...

{
    ...
    paStack6 = unk_io_op_1010_830a(globals.dat_1050_14cc, param_2, unaff_SS);
...

{
    ...
    PStack24 = (POINT16)str_var1(param_2, param_3);
    uStack16 = 0x0;
    iStack26 = 0x0;
    while(true)
    {
...

{
    ...
    if(((param_1 + 0x1c) != 0x0) && ((param_3 != 0x0 || (param_2 != 0x0))))
    {
        ...
        do
        {
            ...
            lStack14 = str_var1(extraout_DX, pu_var2);
...

{
    ...
    {
        (iVar1 + 0x20) = 0x1;
        pass1_1008_5784(str_var1(unaff_SS, local_a), *(iVar1 + 0x1c));
        while(true)
        {
...
pub fn pass1_1010_8096(param_1: *mut u32, i16 param_2)

{
    ...
    str_1000_4d58(((uVar3 + 0xe82) * 0x4 + 0x2526), 0x0, 0x0,
                  str_var1(unaff_SS, local_206),
                  str_var1(unaff_SS, local_306));
    unk_str_op_1000_3d3e(str_var1(unaff_SS, local_106), str_var1(unaff_SS, local_206));
    if(param_2 == 0x2)
    {
    ...
    pass1_1000_3cea(str_var1(unaff_SS, local_106), puVar6);
    pass1_1000_3cea(str_var1(unaff_SS, local_106), str_var1(unaff_SS, local_306));
    pcVar5 = set_err_mode_1010_8b14(param_1, str_var1(unaff_SS, local_106), unaff_SS);
    u_var2  = (pcVar5 >> 0x10);
