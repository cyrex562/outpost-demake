...
pub fn pass1_1020_04f6(u16 *param_1, param_2: u16, param_3: *mut u8, param_4: i16, param_5: u16)

{
    ...
    puVar5 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x1, param_5, param_3, param_4);
    uVar3 = (puVar5 >> 0x10);
    ...
    puVar5 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x48, param_5, extraout_DX, param_4);
    iVar2 = puVar5;
...
u16 *struct_1018_e100(u16 *param_1, param_2: u16, param_3: *mut u8, param_4: u16) {
    ...
    pu_var2 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x36, param_4, param_3, unaff_DI);
...
// LAB_1018_c4bb:
    puVar3                = mixed_1010_20ba(globals.dat_1050_0ed0, 0x48, param_9, param_10, unaff_DI);
    iVar1                 = puVar3;
...
pub fn pass1_1018_6198(u16 *param_1, param_2: u32, param_3: u16, param_4: *mut u8, param_5: i16, param_6: u16) {
    ...
    pu_var2 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x39, param_6, param_4, param_5);
    iVar1.field_0x6 = pu_var2;
    iVar1.field_0x8 = (pu_var2 >> 0x10);
    return;
}
...

{
    ...
    puVar4 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2, param_2, pu_var2, param_1);
...

{
    ...
    *(param_1 + 0xe) = param_2[0x1];
    puVar1           = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2, param_4, param_1, param_1);
...

{
    ...
    puVar3  = mixed_1010_20ba(globals.dat_1050_0ed0, 0x48, param_4, param_3, unaff_DI);
    u_var2   = (puVar3 >> 0x10);
...

{
    ...
    let mut extraout_DX_07: *mut u8;
    let mut extraout_DX_08: *mut u8;
    let mut iVar17: i16;
    let mut uVar18: u16;
    let mut uVar19: u16;
    ...
    for(uStack4 = 0x21; - 0x1 < uStack4; uStack4 = uStack4 - 0x1)
    {
        ...
        if(puVar14 != 0x0)
        {
            ...
            uVar4    = str_op_1008_60e8(str_var1(puVar14, uVar13));
            uVar12   = uVar4;
            uStack26 = str_var1(puVar14, uVar4);
    ...
    if(BVar5 != 0x0)
    {
        ...
        while(true)
        {
            ...
            uStack22 = str_var1(extraout_DX_03, puVar6);
            ...
            // LAB_1018_53f0:
                ...
                else
                {
                    ...
                    pu_var20 = struct_1018_48b0(str_var1(puVar15, uVar4), (uStack22 + 0xa),
...

{
    ...
    else
    {
        ...
        else
        {
            if(iVar11 == 0x3)
            {
                uVar4 = pass1_1008_c646(globals.dat_1050_06e0,
                  str_var1((iVar1 + 0x2), (globals.dat_1050_06e0 >> 0x10)), unaff_SS);
                if(uVar4 == 0x0)
                {
                    uVar4 = 0x4f;
                }
...
pub fn pass1_1018_30fc(param_1: u32, u16 **param_2, u8 *param_3)

{
    ...
    *param_2 = 0x0;
    ...
    if(uVar1 != 0x0)
    {
        ...
        puStack18 = str_var1(param_3, uVar4);
...

{
    ...
    piVar3                     = &local_a;
    uVar5                      = unaff_SS;
    u_stack6                    = mixed_1010_20ba(globals.dat_1050_0ed0, 0x48, unaff_SS, (p_var2 >> 0x10), unaff_DI);
...

{
    ...
    if(param_2 == 0x0)
    {
        ...
        {
            puVar6 = mixed_1010_20ba(globals.dat_1050_0ed0, param_3, param_6, param_4, param_5);
            if(iVar5.field_0x20 != 0x0)
            {
                ...
                pass1_1010_1ea6(iVar5.field_0x20, str_var1(uVar4, iVar3), param_6);
            }
            ...
            (**ppcVar1)(SEG_1010, u_var2, (u_var2 >> 0x10), 0x0, param_3, uVar4);
            param_4 = extraout_DX;
        }
...

{
    ...
    uStack50 = str_var1(extraout_DX, puVar3);
    puVar6 = extraout_DX;
    mem_op_1000_179c(0x14, extraout_DX, 0);
    ...
    if((uStack28 | uStack30) != 0x0)
    {
        ...
        while(true)
        {
            ...
            if((iVar11 + 0x3c) == (puVar5 + 0x8))
            {
                ...
                uStack56 = str_var1(extraout_DX_01, uVar9);
...

{
    ...
    while(true)
    {
        ...
        if(iVar9.field_0x3c == (puVar3 + 0x8))
        {
            ...
            uVar4   = puVar10;
            uVar9   = 0x38;
            pass1_1038_4e78(uVar4, puVar6, str_var1(uVar7, puVar3), puVar10);
            puStack48 = str_var1(puVar6, uVar4);
            ppcVar1   = (*puStack48 + 0x10);
            uVar7     = uVar4;
            (**ppcVar1)(SEG_1038, uVar4, puVar6);
            uStack52 = str_var1(extraout_DX, uVar7);
            param_2  = extraout_DX;
    ...
    if((uStack30 | uStack30) != 0x0)
    {
        ...
        while(true)
        {
            ...
            if(iVar9.field_0x3c == (puVar3 + 0x8))
            {
                ...
                puStack56 = str_var1(puVar6, uVar4);
                ppcVar1   = (*puStack56 + 0x10);
                uVar7     = uVar4;
                (**ppcVar1)(0x38, uVar4, puVar6);
                uStack52 = str_var1(extraout_DX_01, uVar7);
                uStack8  = extraout_DX_01;
...

{
    ...
    uVar6  = param_1;
    uVar8  = param_1;
    pu_var2 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x48, param_1, puVar1, unaff_DI);
    ...
    uVar4              = pass1_1008_4772((paVar3 & 0xffff0000 | iVar3.field_0x24));
    uVar1              = (uVar4 >> 0x10);
...

{
    ...
    puVar3 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x3, param_4, param_2, param_3);
...

{
    ...
    puVar3 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2f, param_2, param_1, param_3);
    u_var2  = (puVar3 >> 0x10);
    uVar1  = *(puVar3 + 0x24);
...

{
    ...
    puStack12 = mixed_1010_20ba(globals.dat_1050_0ed0, uStack8, param_5, param_4, unaff_DI);
    ...
    {
        uVar13 = SEG_1008;
        struct_op_1008_8e9e(str_var1(puVar8, uVar4), 0x6, 0x24);
        (iVar11 + 0x12) = uVar4;
        (iVar11 + 0x14) = uVar9;
    }
    ...
    for(iStack36 = 0x0; iStack36 < uVar4; iStack36 = iStack36 + 0x1)
    {
        ...
        if((extraout_DX | uVar6) != 0x0)
        {
            ...
            pass1_1018_dd7c(uVar1, (uVar1 >> 0x10),
                            str_var1(iStack36 % 0x6, iVar5), uVar6 & 0xffff | extraout_DX << 0x10, uVar10, param_5);
...

{
    ...
    puVar7                      = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2f, param_3, puVar5, unaff_DI);
    ...
    puVar7 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2, param_3, extraout_DX, unaff_DI);
    puVar5 = (puVar7 >> 0x10);
    if((puVar7 + 0x80) != 0x0)
    {
        uVar9.field_0x84 = 0x2;
    }
    puVar7            = mixed_1010_20ba(globals.dat_1050_0ed0, 0x9, param_3, puVar5, unaff_DI);
    puVar5            = (puVar7 >> 0x10);
    uVar9.field_9e = puVar7;
    uVar9.field_0xa0 = puVar5;
    uVar4             = pass1_1010_65d0(param_3, puVar7 & 0xffff0000 | uVar9.field_9e, 0x88);
    if(uVar4 != 0x0)
    {
        uVar9.field_0xa8 = 0x1;
    }
    puVar7            = mixed_1010_20ba(globals.dat_1050_0ed0, 0x3b, param_3, puVar5, unaff_DI);
...

{
    ...
    puVar8  = str_var1(unaff_SS, &local_8);
    puVar7  = str_var1(unaff_SS, &local_a);
    puVar6  = mixed_1010_20ba(globals.dat_1050_0ed0, 0x48, unaff_SS, in_DX, unaff_DI);
    ...
    if((uVar8 | uVar1) != 0x0)
    {
        ...
        if((uVar1 | uStack1034) != 0x0)
        {
            ...
            sys_1000_3f9c(local_402,
                          ...
                          param_4,
                          param_5);
            string_1040_a626((uVar4 & 0xffff0000 | (iVar7 + 0xa)), str_var1(param_4, local_402), uVar9);
            uVar4           = *(iVar10 + 0x2);
            uVar11          = (iVar10 + 0x4);
            iVar10          = uVar4;
            ...
            sys_1000_3f9c(local_402,
                          ...
                          param_4,
                          param_5);
            string_1040_a626((uVar4 & 0xffff0000 | (iVar10 + 0x14)),
