...
//                halt_baddata();
            ...
            case0xb:
                ...
                iVar14    = 0x1d;
                uStackY78 = 0x7b0a;
                pu_var25   = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2b, param_9, puVar17, param_7);
            ...
            code_r0x10287b17:
                ...
                puStack10 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2, param_9, puVar17, param_7);
                pcStack12 = (fn_ptr_1)PTR_LOOP_1050_13ae;
                if(0x2 < globals.PTR_LOOP_1050_13ae) {
                    pu_var25 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2f, param_9, (puStack10 >> 0x10), param_7);
...
void  pass1_1028_e28a(param_1: *mut u8, param_2: i16, param_3: u16) {
    ...
    puVar4  = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2f, param_3, param_1, param_2);
    uVar3   = (puVar4 >> 0x10);
    pu_var2  = (puVar4 + 0xa);
    ppcVar1 = (*pu_var2 + 0x4);
...
void  pass1_1028_c3aa(param_1: u16, param_2: u16,param_3: *mut u16, param_4: u32, param_5: u32, param_6: u16) {
    ...
    if(0x1e < puStack24) {
        uVar3   = 0x87;
        puVar13 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x9, param_6, puVar8, unaff_DI);
...
void  pass1_1028_ccd0(param_1: u8, param_2: u16, param_3: u32, u16 *param_4) {
    ...
    puStack48 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2f, param_2, puVar5, unaff_DI);
