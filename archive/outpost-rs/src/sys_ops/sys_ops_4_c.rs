...
u16 pass1_1028_af08(param_1: *mut Struct693, param_2: *mut u8, param_3: i16, param_4: u16) {
    ...
    puVar7 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2, param_4, param_2, param_3);
    puVar4 = (puVar7 >> 0x10);
...
// LAB_1028_af42:
    ...
    paVar8             = mixed_1010_20ba(globals.dat_1050_0ed0, 0x37, param_4, puVar4, param_3);
    ...
    puVar7 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2b, param_4, puVar4, param_3);
...
pub fn pass1_1028_9efc(param_1: u32,param_2: *mut u16, param_3: u16, param_4: i16, param_5: u16, param_6: u8) {
    ...
    if((param_3 | param_2) != 0x0) {
        ...
        while(true) {
            ...
            if(pu_var2[0xff] != 0x0) {
                ...
                if(lVar1 != 0x8000002) {
                    ...
                    if(puVar6 != 0x0) {
                        paVar8 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x37, param_5, puVar6, param_4);
        ...
        uStack22 = SEG_1008;
        puVar9   = mixed_1010_20ba(globals.dat_1050_0ed0, 0x8, param_5, 0x0, param_4);
        puVar6   = (puVar9 >> 0x10);
        iVar4    = puVar9;
        pass1_1028_e1ec(globals._PTR_LOOP_1050_65e2, 0x1, 0x400);
        pu_stack6 = iVar4;
        ...
        if(iVar4 != 0x0) {
            ...
            if(iVar4 < 0x1) {
                ...
                puVar9 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x37, param_5, puVar6, param_4);
                puVar6 = (puVar9 >> 0x10);
                post_win_msg_1008_a0e4((puVar9 & 0xffff | ZEXT24(puVar6) << 0x10), 0x0, iVar4, (pu_stack6 + 0x208), 0x4000001, 0x2, SEG_1008, param_5);
                puVar9 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2b, param_5, puVar6, param_4);
...
void struct_op_1028_933c(param_1: *mut Struct100, param_2: u16, param_3: u16, param_4: u16, param_5: *mut u32, param_6: u16, param_7: u32, param_8: u32, param_9: u16, param_10: u8) {
    let mut iVar1: i16;
    let mut pu_var2: *mut u8;
...
pub fn pass1_1028_767e(param_1: i16, param_2: u16, param_3: i16, param_4: u16) {
    ...
    if(((param_1 + 0x152) != 0x0) && (((qword)*_PTR_LOOP_1050_65e2 % 0x64) == 0x0)) {
        puVar1 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x40, param_4, 0x0, param_3);
...
pub fn pass1_1028_78b8(param_1: u32, long param_2, param_3: i16, param_4: u16, param_5: u8) {
    ...
    if(pu_stack6 == 0x12c) {
        ...
        iVar9     = 0xf;
        uVar15    = 0x1;
        puVar13   = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2b, param_4, puVar8, param_3);
        puVar8    = (puVar13 >> 0x10);
        puVar6    = puVar13;
        local_30  = puVar6;
        puStack46 = puVar8;
    ...
    if(pu_stack6 == 0x3d) {
        puVar13     = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2, param_4, puVar8, param_3);
        uVar10      = puVar13 >> 0x10;
        local_30    = puVar13;
        puVar8      = (puVar13 >> 0x10);
        ...
        if(globals.PTR_LOOP_1050_13ae != (&PTR_LOOP_1050_0000 + 0x1)) {
            ...
            iVar9     = 0x10;
            uVar15    = 0x1;
            puVar13   = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2b, param_4, 0x0, param_3);
            puVar8    = (puVar13 >> 0x10);
            puVar6    = puVar13;
            puStack20 = puVar6;
            puStack18 = puVar8;
    ...
    if(0x2 < globals.PTR_LOOP_1050_13ae) {
        puStack74 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2f, param_4, puStack8, param_3);
            ...
            if(uVar5 == 0x0) {
                ...
                while(true) {
                    ...
                    if((pu_var2 + 0x200) != 0x8000002) {
                        ...
                        uVar6    = 0x10;
                        puVar7   = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2, param_4, puVar4, param_3);
                        uVar5    = puVar7 >> 0x10;
        ...
        if(uVar5 == 0x0) {
            ...
            while(true) {
                ...
                if((pu_var2 + 0x200) != 0x8000002) {
                    ...
                    uVar6     = 0x10;
                    puVar8    = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2, param_3, puVar4, param_2);
                    uVar5     = puVar8 >> 0x10;
...
pub fn pass1_1028_4194(param_1: *mut u32, param_2: u16, param_3: u16, param_4: u16, param_5: u16) {
    ...
    if(((u_var2 + 0x200) != 0x8000002) && ((param_1 + 0x12) == 0x5)) {
        puVar3 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2b, param_5, puVar1, param_3);
...
pub fn pass1_1028_43c2(param_1: i16, param_2: u16, param_3: i16, param_4: *mut u8, param_5: i16, param_6: u16) {
    ...
    if(param_3 == 0x0) {
        puVar1 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x8, param_6, param_4, param_5);
...
pub fn pass1_1028_43f6(param_1: u32, param_2: i16, param_3: *mut u8, param_4: u16, param_5: i16, param_6: u16) {
    ...
    uVar1  = 0x83;
    pu_var2 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x9, param_6, param_3, param_5);
