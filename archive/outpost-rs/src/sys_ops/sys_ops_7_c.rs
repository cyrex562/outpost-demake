...
void  pass1_1010_d5ae(param_1: *mut u8, param_2: u32,param_3: *mut u16, param_4: *mut u8, param_5: u8, i16 param_6)
...
void  pass1_1010_d710(param_1: u32, param_2: u32,param_3: *mut u16, param_4: *mut u8, param_5: u8)

{
    ...
    {
        iStack14 = 0x0;
        pass1_1000_4906(str_var1(param_4, &local_a2), 0x0, 0x94);
        pass1_1000_4906(str_var1(param_4, local_136), 0x0, 0x94);
        iStack314 = 0x0;
        iStack312 = 0x0;
        iStack316 = 0x0;
        uVar1     = iVar9.field_0x6;
        ...
        while(iStack312 != 0x0)
        {
            fn_ptr_1000_17ce((&local_a2)[iStack312 + -0x1], SEG_1000);
            iStack312 = iStack312 + -0x1;
        }
...
void  pass1_1010_d984(param_1: u16, param_2: u16, i16 *param_3, param_4: i16, param_5: u32, param_6: u32, param_7: u32, param_8: *mut u8, param_9: u8)

{
    ...
    let mut uVar8: u16;
    let mut uVar9: u16;
    let mut puStack1052: *mut u16;
    let mut local_418: [u8;400] = [0;400];
...
u16  pass1_1010_db2e(param_1: u16, param_2: u16, param_3: u16, param_4: u32, param_5: u32, param_6: u32, i16 *param_7, param_8: *mut u8, param_9: u8)

{
    let mut uVar1: u16;
    let mut iVar2: *mut Struct493;
    let mut iVar3: i16;
    let mut uVar4: u16;
    let mut iVar4: *mut Struct492;
    let mut uVar5: u16;
    let mut uVar6: u16;
    let mut uVar7: u16;
    ...
    while(true)
    {
        ...
        iVar2 = (iVar4->fld2_segment + uStack94 * 0xa);
        uVar5 = (param_5 >> 0x10);
        uVar6 = (param_4 >> 0x10);
...
i16  string_1010_dcac(param_1: u16, param_2: u16, param_3: u16, param_4: i16, param_5: u32, param_6: *mut Struct104)

{
    let mut uVar1: u32;
    let mut iVar2: *mut Struct105;
    let mut u_var2: u16;
    let mut uVar3: u16;
    let mut iVar5: *mut Struct104;
    let mut uVar6: u16;
    let mut uVar7: u16;
    let mut pcVar4: *mut c_char;

    pcVar4           = load_string_1010_847eglobals.dat_1050_14cc, globals.dat_1050_14cc >> 0x10), param_1);
    uVar6            = (param_6 >> 0x10);
    iVar5            = param_6;
    u_var2            = (&iVar5->fld2_segment + 0x2);
    iVar2            = (&iVar5->fld2_segment + param_4 * 0xa);
    uVar7            = (param_5 >> 0x10);
...
void  pass1_1010_debe(param_1: u32, param_2: u16,param_3: *mut u16, param_4: *mut u32, param_5: u32, param_6: u16)

{
    ...
    *param_3 = 0x0;
    ...
    puVar10  = mixed_1010_20ba(globals.dat_1050_0ed0, 0x35, param_6, puVar6, unaff_DI);
    puVar6   = (puVar10 >> 0x10);
    iVar7    = param_4;
    uVar8    = (param_4 >> 0x10);
    if(param_2 == 0x13)
...
void  pass1_1010_e58a(param_1: u32, param_2: u32, param_3: *mut u8, param_4: i16, param_5: u16)

{
    ...
    *(iVar6 + 0x13c) = 0x0;
    ...
    if(BVar3 == 0x0)
    {
        ...
        puVar8  = mixed_1010_20ba(globals.dat_1050_0ed0, 0x31, param_5, param_3, param_4);
        ppcVar1 = (*puVar8 + 0x14);
    ...
    {
        puVar8  = mixed_1010_20ba(globals.dat_1050_0ed0, 0x41, param_5, param_3, param_4);
        ppcVar1 = (*puVar8 + 0x14);
        (**ppcVar1)(SEG_1008, puVar8, (puVar8 >> 0x10), puVar4, puVar4 >> 0xf);
...
void  pass1_1010_bffa(param_1: u32, param_2: i16, param_3: *mut u8, param_4: u16)

{
    ...
    let mut uVar3: u16;
    let mut uVar4: u16;
    let mut puVar5: *mut Struct257;
    let mut iVar6: *mut Struct254;
    let mut iVar7: *mut Struct255;
    let mut iVar8: *mut Struct256;
    let mut iVar5: i16;
    let mut uVar6: u16;
    let mut uVar7: u16;
    ...
    else
    {
        ...
        if((param_3 | iVar8.field_0x4) != 0x0)
        {
            ...
            *puVar1                 = paVar8;
            ...
            pass1_1028_dc52(str_var1(param_4, local_18), 0x1, 0x0, 0x200);
            iStack30 = 0x1;
            while(true)
            {
                puVar5 = local_18;
                ...
                paVar8                         = unk_io_op_1010_830a(globals.dat_1050_14cc, uStack34, param_4);
                uVar3                          = (paVar8 >> 0x10);
...
void  pass1_1010_c28a(param_1: *mut u8, param_2: i16, param_3: u16)

{
    ...
    puVar5 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2f, param_3, param_1, param_2);
    u_var2  = (puVar5 >> 0x10);
    uVar1  = (puVar5 + 0x24);
    uVar4  = (puVar5 + 0x26);
    uVar3  = uVar4 | uVar1;
...
lobals starting with '_' overlap smaller symbols at the same address
  ...
  void
  pass1_1010_c320(param_1: u16, param_2: u16, param_3: *mut u8, param_4: u32, u8 *param_5)
...
void  pass1_1010_c3c2(param_1: u16, param_2: u16, param_3: u32, param_4: u32, param_5: *mut u8, param_6: u8, param_7: u16)

{
    let mut uVar1: u16;
    let mut u_var2: u16;
    let mut uVar3: u16;
    let mut local_40c: [u8;400] = [0;400];
...
void  string_op_1010_c446(param_1: u16, param_2: u8, param_3: *mut u8, param_4: u32, char *param_5, param_6: u32)

{
    ...
    0x6 =>
        ...
        pcVar5   = load_string_1010_847eglobals.dat_1050_14cc, globals.dat_1050_14cc >> 0x10), SEG_1000);
        uVar7    = pcVar5;
...

{
    ...
    _ =>
        ...
        fn_ptr_1000_17ce(str_var1(puVar4, uVar1), SEG_1000);
        return;
    0xa =>
    ...
    if(ppuStack14 != (u8 **)0x0)
    {
        ...
        *(uVar1 + 0x6) = param_4;
        (uVar1 + 0xa)  = param_3;
        (uVar1 + 0x12) = uStack18;
        pass1_1010_a50c(str_var1(param_2, param_1), ppuStack14, str_var1(puVar4, uVar1));
    }
    return;
}
...
void  pass1_1010_c864(param_1: u32,param_2: *mut u16, param_3: *mut Struct104, param_4: *mut u8, param_5: *mut u8, param_6: u8)

{
    ...
    let mut paStack412: *mut Struct18;
    let mut uStack408: u32;
    let mut uStack404: u32;
    let mut uStack400: u16;
    let mut uStack398: u32;
    let mut local_18a: u32;
    ...
    iStack94 = 0x0;
    pass1_1000_4906(str_var1(param_5, &local_f6), 0x0, 0x94);
    uStack404 = pass1_1000_4906(str_var1(param_5, &local_18a), 0x0, 0x94);
    uStack398       = 0x0;
    for(uStack400 = 0x1; uStack400 < 0x25; uStack400 = uStack400 + 0x1)
    {
        uStack404       = pass1_1030_7c28(*(iVar11 + 0x6), uStack400, uStack404, uStack404, param_5);
    ...
    uVar15    = SEG_1000;
    uStack398 = uVar8;
    pass1_1000_4906(str_var1(param_5, &local_18a), 0x0, 0x54);
    uVar4     = (iVar11 + 0x6);
    uVar14    = (uVar4 >> 0x10);
    iVar12    = uVar4;
    ...
    if(uVar9 != 0x0)
    {
        ...
        uVar9 = extraout_DX;
        pass1_1000_4906(str_var1(param_5, &local_f6), 0x0, 0x54);
        uVar6 = SEG_1000;
        pass1_1000_4906(str_var1(param_5, &local_1f0), 0x0, 0x54);
        uStack398 = 0x0;
...
void  pass1_1010_cc56(param_1: u32, param_2: u32, param_3: *mut Struct104, param_4: u16, param_5: *mut u8, param_6: u8)

{
    ...
    if(uStack324 != 0x0)
    {
        iStack14 = param_3;
        iStack18 = 0x0;
        pass1_1000_4906(str_var1(param_5, &local_aa), 0x0, 0x94);
        pass1_1000_4906(str_var1(param_5, &local_13e), 0x0, 0x94);
        uStack12 = 0x0;
        uStack16 = 0x0;
        uStack22 = 0x0;
        ...
        pass1_1000_4906(str_var1(param_5, &local_13e), 0x0, 0x54);
        ...
        pass1_1000_4906(str_var1(param_5, &local_aa), 0x0, 0x54);
        uVar4 = SEG_1000;
        pass1_1000_4906(str_var1(param_5, &local_1a0), 0x0, 0x54);
...
void  pass1_1010_cf36(param_1: u32, param_2: u32,param_3: *mut u16, param_4: u8, u8 *param_5)

{
    ...
    {
        iStack14 = 0x0;
        pass1_1000_4906(str_var1(param_5, &local_a2), 0x0, 0x94);
        pass1_1000_4906(str_var1(param_5, local_136), 0x0, 0x94);
        uStack314 = 0x0;
        iStack312 = 0x0;
        iStack316 = 0x0;
        uVar1     = iVar9.field_0x6;
...
void  pass1_1010_d24a(param_1: u32, param_2: u32,param_3: *mut u16, param_4: *mut u8, param_5: u8)

{
    ...
    if(puVar6 != 0x0)
    {
        ...
        iStack18 = 0x0;
        pass1_1000_4906(str_var1(param_4, &local_a6), 0x0, 0x94);
        puVar4    = pass1_1000_4906(str_var1(param_4, local_13a), 0x0, 0x94);
        lStack318 = 0x0;
        for(uStack320 = 0x1; uStack320 < 0x25; uStack320 = uStack320 + 0x1)
        {
        ...
        while(lStack318 != 0x0)
        {
            ...
            fn_ptr_1000_17ce((&local_a6)[lStack318], SEG_1000);
            lStack318 = lStack318 + -0x1;
        }
...
void  pass1_1010_9fee(param_1: *mut Struct252, param_2: u16, param_3: u16, param_4: u16, u8 *param_5)

{
    let mut ppcVar1: *mut *mut c_void;
    let mut pu_var2: *mut u8;
    let mut extraout_DX: *mut u8;
    let mut iVar3: *mut Struct252;
    let mut iVar4: *mut Struct253;
    let mut uVar3: u16;
    let mut uVar4: u16;
    let mut uVar5: u16;
...
void  pass1_1010_a0a0(param_1: u32, param_2: *mut u8, param_3: i16, param_4: u16)

{
    ...
    iStack12 = 0x4;
    mixed_1010_20ba(globals.dat_1050_0ed0, 0x2, param_4, param_2, param_3);
...
void  pass1_1010_a69c(param_1: u32, param_2: u16, param_3: i16, param_4: *mut u8, param_5: i16, param_6: u16)

{
    ...
    let mut puVar4: *mut u8;
    let mut paVar5: *mut Struct25;
    let mut paVar6: *mut Struct67;
    let mut puVar7: *mut u16;
    let mut uVar8: u16;
    let mut uVar9: u16;
    let mut uVar10: u16;
    ...
    puVar7 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x35, param_6, puVar3, param_5);
    puVar3 = (puVar7 >> 0x10);
    u_var2  = param_1;
    uVar8  = (param_1 >> 0x10);
    puVar4 = puVar3;
    ...
    0x1e =>
        u_var2  = 0x1;
        iVar1  = 0x2;
        puVar7 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2b, param_6, puVar3, param_5);
        puVar3 = (puVar7 >> 0x10);
        pass1_1010_08c0(puVar7, u_var2, iVar1, param_6);
        paVar5 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x40, param_6, puVar3, param_5);
        puVar3 = (paVar5 >> 0x10);
...
switchD_1010_aaef_caseD_b:
    paVar6 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x37, param_6, puVar3, param_5);
    puVar3 = (paVar6 >> 0x10);
