...
u16 * pass1_1020_d3a4(u16 *param_1, param_2: u16, param_3: i16, param_4: u32, param_5: u16)
...

{
    ...
    if(uVar1 != 0x0)
    {
        uVar3                       = pass1_1038_af40(globals.ptr_1050_5b7c, (globals._PTR_LOOP_1050_4230 + 0x16), 0x11, param_6, globals._PTR_LOOP_1050_4230, SEG_1038, unaff_SS);
        pu_var2                      = (uVar3 >> 0x10);
        globals.PTR_LOOP_1050_5b80 = (&PTR_LOOP_1050_0000 + 0x1);
        unk_win_msg_op_1008_9510(&PTR_LOOP_1050_5b80, SEG_1008, unaff_SS);
        puVar4           = mixed_1010_20ba(globals.dat_1050_0ed0, 0x3a, unaff_SS, pu_var2, param_7);
...
void  pass1_1020_d4ca(param_1: u32, i16 param_2)
...

{
    ...
    if(iStack22 < uStack20)
    {
        ...
        uVar4    = (uVar5 >> 0x10);
        pu_var2   = &local_1a;
        pass1_1030_64ce(param_3, pu_var2, uVar4, globals._PTR_LOOP_1050_5740,
                        str_var1(param_3, pu_var2), uVar5 & 0xffff | uVar4 << 0x10, puVar7);
        uStack40 = *pu_var2;
        uVar4    = (pu_var2 + 0x2);
        bStack55 = (u8)(uStack40 >> 0x18);
        uVar3    = bStack55;
        if(bStack55 != 0x0)
        {
            uStack36 = uStack40;
            pass1_1028_e1ec(globals._PTR_LOOP_1050_65e2, uStack40, uVar4);
            puVar6 = struct_op_1030_73a8(str_var1(uVar4, uVar3));
            if((puVar6 + 0xc) == 0x6a)
            {
                ppcVar1 = (*puVar6 + 0x24);
                (**ppcVar1)();
...
void  pass1_1020_bc92(u16 *param_1, param_2: u16, param_3: u16)
...

{
    ...
    pass1_1018_c402(param_1, 0x0, 0x73b, 0x2e,
                    ...
                    str_var1(param_2, uVar4), param_3, param_4, uVar1);
    ...
    do
    {
        ...
        if(uVar3 != 0x0)
        {
            ...
            pass1_1020_b240(param_1, uVar5,
                            ...
                            str_var1(param_1, puVar4), param_6);
            if(puVar4 != 0x0)
            {
            // LAB_1020_b46e:
...

{
    ...
    while(true)
    {
        ...
        uStack26 = str_var1(uVar4, puVar1);
        uVar5    = uVar4 | puVar1;
        if(uVar5 == 0x0)
        {
...
u32  pass1_1020_6498(param_1: u32, i16 param_2)
...
u16  pass1_1020_64d4(param_1: u32, i16 param_2)
...
void  pass1_1020_1f74(u16 *param_1, param_2: u16) {
...
void  pass1_1020_2286(param_1: u16, param_2: u16, i16 *param_3, i16 param_4)
...
void  pass1_1020_05d6(u16 *param_1, param_2: u16) {
...

{
    ...
    {
        puVar11 = mixed_1010_20ba(globals.dat_1050_0ed0, 0x2f, param_6, param_5, unaff_DI);
        puVar8  = (puVar11 >> 0x10);
        if((puVar11 + 0x1e) == 0x0)
        {
            uStack20 = param_4;
...

{
    ...
    uVar3  = 0xf3;
    uVar5  = 0xa6;
    puVar4 = pass1_1008_941a(str_var1(param_4, local_6), 0x1, 0x8f);
    u_var2  = (puVar4 >> 0x10);
    pass1_1018_c402(param_1, 0x0, 0x734, 0x28,
                    str_var1(puVar4, 0x32c8),
...

{
    ...
    uVar3  = 0xf5;
    uVar5  = 0xbf;
    puVar4 = pass1_1008_941a(str_var1(param_4, local_6), 0x1, 0x92);
    u_var2  = (puVar4 >> 0x10);
    pass1_1018_c402(param_1, 0x737, 0x736, 0x2a,
                    str_var1(puVar4, 0x6590),
                    str_var1(uVar3, u_var2),
                    str_var1(param_2, uVar5), param_3, param_4, u_var2);
    uVar3              = (param_1 >> 0x10);
...

{
    ...
    uVar3  = 0xf8;
    uVar5  = 0xc2;
    puVar4 = pass1_1008_941a(str_var1(param_4, local_6), 0x1, 0x96);
    u_var2  = (puVar4 >> 0x10);
    pass1_1018_c402(param_1, 0x0, 0x73a, 0x2d,
                    str_var1(puVar4, 0x2328),
                    str_var1(uVar3, u_var2),
                    str_var1(param_2, uVar5), param_3, param_4, u_var2);
    uVar3              = (param_1 >> 0x10);
...
void  pass1_1018_642e(param_1: u16, param_2: u16, i16 *param_3, i16 param_4)
...
void  pass1_1018_50ac(u16 *param_1, param_2: u16) {
    u32 * puVar1;
    let mut u_var2: u16;
    let mut ppcVar3: *mut *mut c_void;
    let mut iVar4: i16;
...

{
    ...
    pass1_1030_6c66(param_3, 0x1, paStack6, uVar5, (uVar6 | uVar4), SEG_1030);
    return;
}
...
u16 * pass1_1018_567c(u16 *param_1, param_2: u8) {
    let mut uVar1: u16;
...
void  pass1_1018_5714(u16 *param_1, param_2: u16) {
