...

{
    ...
    while(true)
    {
        ...
        uStack16 = str_var1(param_2, uVar3);
...

{
    ...
    pass1_1008_3e38(str_var1(param_2, local_8));
    pass1_1008_6d64((param_1 & 0xffff0000 | (param_1 + 0x28)),
                    str_var1(param_2, local_8));
    pass1_1008_3e94(
      str_var1(param_2, local_8), str_var1(param_2, local_c), str_var1(param_2, local_a));
    return;
}


Struct18 * pass1_1030_8e12(param_1: *mut Struct18, param_2: u8)
            ...
            do
            {
                ...
                if(0x0 < (iStack8 * 0x2 + globals._PTR_LOOP_1050_580e))
                {
                    ...
                    if((uVar3 <= uVar4) && ((uVar3 < uVar4 || (u_var2 < uVar1))))
                    {
                        ...
                        u_stack6 = str_var1(((u_stack6 >> 0x10) - (u_var2 >> 0xf)) - (u_stack6 < u_var2), u_stack6 - u_var2);
                    }
                }
                iStack8 = iStack8 + 0x1;
                if(0x24 < iStack8)
...

{
    ...
    u_var2 = (param_1 + 0x22);
    u_var2 = pass1_1020_bae6(u_var2, str_var1(param_2, (u_var2 >> 0x10)), param_3, param_4, param_5);
    return u_var2;
}


void  pass1_1030_7c50(param_1: *mut Struct305, long param_2, param_3: i16, param_4: u16, u8 *param_5)

{
    ...
    if(iVar8.field_0x1e == 0x0)
    {
        ...
        {
            struct_op_1030_1cd8(str_var1(param_5, param_4), 0x5, 0x5);
    ...
    while(param_2 != 0x0)
    {
        ...
        puStack18 = str_var1(uVar7, uVar5);
...

{
    ...
    uVar1 = (param_1 >> 0x10);
    return str_var1((param_1 + 0x18), (param_1 + 0x16)) & 0xffffff;
}


u16 * pass1_1030_80ee(u16 *param_1, param_2: u8, param_3: u16)
...
void  pass1_1030_8308(param_1: u16, param_2: u16,param_3: *mut u16,param_4: *mut u16, param_5: u32, param_6: u16, param_7: u16)
...
void vsprintf_op_1030_840a(param_1: u32, LPSTR param_2, WORD *param_3, param_4: u16)

{
    ...
    if(globals.PTR_LOOP_1050_574c != 0x0)
    {
        ...
        if(globals.PTR_LOOP_1050_5750 == 0x0)
        {
            ...
            globals._PTR_LOOP_1050_5752 = str_var1(param_4, pCVar1);
...
void  pass1_1030_8660(param_1: u32, param_2: *mut u32, param_3: u16, param_4: u16, param_5: u16, param_6: u16, i16 param_7)

{
    ...
    if(uVar1 == 0x0)
    {
        ...
        pu_stack6 = str_var1(uVar1, param_4);
        uVar1    = uVar1 | param_4;
        if(uVar1 == 0x0)
        {
...
void  pass1_1030_871e(param_1: *mut Struct681, param_2: *mut u32, param_3: u16, param_4: i16, param_5: u16)

{
    let mut pi_var1: *mut i16;
    let mut iVar2: *mut Struct681;
    let mut u_var2: u16;
...
void  pass1_1030_877c(u16 *param_1, param_2: i16, param_3: u16)
...
void  pass1_1030_8834(u16 *param_1, param_2: i16, param_3: u16)
...
void  pass1_1030_88ce(u16 *param_1, param_2: u32, param_3: u32, param_4: u16)

{
    let mut puVar1: *mut u8;
    let mut pu_var2: *mut u8;
    let mut iVar4: *mut Struct354;
    let mut uVar3: u16;
    let mut uVar4: u32;
    ...
    pass1_1008_3e54(str_var1(param_4, local_14), 0x0, uStack14 - 0x1, uStack10 - 0x1);
    pass1_1008_3e54(str_var1(param_4, local_1a), 0x0, 0x0, 0x0);
    pass1_1008_6d18(puStack38, str_var1(param_4, local_14), str_var1(param_4, local_1a));
    pass1_1008_6d64(puStack38, str_var1(param_4, local_1a));
    pass1_1008_3eb4(str_var1(param_4, local_1a),
...

{
    ...
    uStack8 = str_var1(uVar3, param_2);
...
void  pass1_1030_6c1a(param_1: u32, i16 param_2)
...
void  pass1_1030_6c4c(param_1: u32, i16 param_2)
...
void  pass1_1030_6d80(param_1: *mut Struct299, param_2: u32)

{
    let mut puVar1: *mut u32;
    let mut u_var2: u16;
    let mut ppcVar3: *mut *mut c_void;
    let mut iVar4: *mut Struct299;
    let mut uVar4: u16;
...
void  pass1_1030_6e9c(param_1: *mut Struct301, long param_2, i16 param_3)
...
void  pass1_1030_73ee(param_1: *mut Struct294, param_2: u32, param_3: u16)

{
    let mut iVar1: *mut Struct294;
    let mut uVar1: u16;
...
{
    return str_var1(param_2, param_1 + 0x14);
}
...
u16 * pass1_1030_5d3c(u16 *param_1, param_2: u32, param_3: u16, u8 *param_4) {
    let mut uVar1: u16;
...

{
    ...
    pass1_1030_8aa0(str_var1(param_6, param_5), param_2, param_3, param_6, param_7);
    return;
}


void  pass1_1030_627e(param_1: u16, param_2: u16, param_3: u16, param_4: u32,param_5: *mut u16, long param_6)

{
    ...
    {
        pass1_1030_8b00(uStack10, param_5, str_var1(param_1, local_12), param_1);
    }
    return;
}


void  pass1_1030_64ce(param_1: u16, param_2: u16, param_3: u16, param_4: u32,param_5: *mut u16, long param_6, u32 *param_7)

{
    ...
    {
        puVar1 = &local_e;
        pass1_1030_8b00(uStack10, param_5, str_var1(param_1, puVar1), param_1);
        u_stack6 = *puVar1;
    }
    *param_7 = u_stack6;
    return;
...
void  pass1_1030_6522(param_1: *mut u32, param_2: u32, param_3: u32, param_4: u16)

{
    ...
    {
        struct_op_1030_1cd8(str_var1(puVar4, pu_var2), 0x5, 0x5);
...

{
    ...
    pass1_1008_5784(str_var1(param_3, local_a), *(param_1 + 0x4));
    while(true)
    {
...
void  pass1_1030_671c(param_1: u32, param_2: u32,param_3: *mut u16, long param_4, param_5: u16, param_6: u16, param_7: i16, param_8: u16)

{
    pass1_1030_677a(param_1, param_4, param_8);
    pass1_1030_8bdc(str_var1(param_6, param_5), param_2, param_3, param_7, param_8);
    return;
}


void  pass1_1030_6740(param_1: u32, param_2: u16, i16 param_3)

{
    let mut uVar1: u32;
    let mut local_a: [u8;8] = [0;8];

    pass1_1008_5784(str_var1(param_2, local_a), *(param_1 + 0x4));
    while(true)
    {
...
void  pass1_1030_4bbe(param_1: u16, param_2: u16, param_3: u32, i16 param_4)
...

{
    ...
    for(iVar5 = 0x2b; iVar5 != 0x0; iVar5 = iVar5- 1)
    {
        pu_var2  = puVar4;
        puVar4  = puVar4 + 0x1;
        puVar1  = puVar6;
...

{
    ...
    while(true)
    {
        ...
        pcStack8 = str_var1(param_5, uVar1);
        if((param_5 | uVar1) == 0x0)
            break;
        if(*pcStack8 != '\"')
        {
            iVar2 = pass1_1000_3e2c(str_var1(param_5, uVar1));
            iVar3 = param_3;
            uVar4 = (param_3 >> 0x10);
            if(iStack4 < 0x25)
            {
...

{
    ...
    while(true)
    {
        ...
        pcStack8 = str_var1(param_1, uVar1);
        if((param_1 | uVar1) == 0x0)
            break;
        if(*pcStack8 != '\"')
        {
            iVar2 = pass1_1000_3e2c(str_var1(param_1, uVar1));
            iVar3 = param_4;
            uVar3 = (param_4 >> 0x10);
            if(iStack4 < 0x25)
            {
...
void  pass1_1030_4e34(param_1: u16, param_2: u16, long param_3, char *param_4)
...

{
    ...
    pass1_1008_5784(str_var1(param_3, local_a), *(param_1 + 0x568));
    do
    {
...

{
    ...
    pu_stack6 = str_var1(param_3, param_2);
...

{
    ...
    let mut local_11e: [u8;10e] = [0;10e];
    let mut uStack16: u32;
    let mut uStack12: u32;
    ...
    {
        pass1_1030_521c(CONCAT13((param_3 >> 0x8), CONCAT12(param_3, local_11e)), *(iVar3 + 0x108), param_3, param_4);
        uStack16 = *_PTR_LOOP_1050_5748;
        fn_ptr_1028_d566(uStack16, str_var1(param_3, local_11e));
...
void  pass1_1030_5a52(param_1: u32, param_2: *mut u32, u32 *param_3)
...

{
    ...
    *(param_1 + 0x10) = param_2;
    ...
    uStack10          = (iStack6 + 0x4);
    uStack14          = (iStack6 + 0x8);
    pass1_1008_3e54(str_var1(param_3, &local_14), 0x0, uStack14 - 0x1, uStack10 - 0x1);
    puVar1 = (param_1 + 0x14);
    pass1_1008_6cb4(str_var1(param_3, local_20), &local_14, param_3, puVar1, u_var2);
    pass1_1008_6d64(str_var1(param_3, local_20), (param_1 & 0xffff0000 | ZEXT24(puVar1)));
    return;
}
...
void  pass1_1030_5b1c(param_1: u32,param_2: *mut u16, u16 *param_3)
...
void  pass1_1030_326a(param_1: *mut Struct692, param_2: u32, param_3: u16, param_4: u16)

{
    let mut uVar1: u16;
    let mut u_var2: u32;
    let mut uVar3: u16;
    let mut iVar4: *mut Struct692;
    let mut uVar4: u16;
    long         lStack6;
    ...
    uVar1 = param_2;
    pass1_1030_38b8();
    lStack6 = str_var1(param_3, uVar1);
...
void  pass1_1030_35a4(param_1: u32, long param_2, param_3: *mut u8, param_4: u16, param_5: u16)

{
    ...
    u_stack6 = str_var1(globals.PTR_LOOP_1050_5f2e, uVar5);
    uVar10  = param_5;
    uVar11  = (param_5 >> 0x8);
    pass1_1030_3948(param_1,
                    str_var1(param_5, local_c), CONCAT13(uVar11, CONCAT12(uVar10, &local_a)), 0x3);
    uVar7 = (&local_a + 0x2U);
    pass1_1030_3948(param_1,
                    str_var1(param_5, &local_a + 0x2U), CONCAT13(uVar11, CONCAT12(uVar10, local_c)), 0x4);
    do
    {
        uVar6 = uVar7;
        if(param_2 < 0x1)
    ...
    pass1_1000_4906((param_1 & 0xffff0000 | (param_1 + 0x18c)), 0x0, 0x18);
    return;
}


void  pass1_1030_3694(param_1: u32, param_2: i16, long param_3, param_4: *mut u8, param_5: u16, param_6: u16)

{
    ...
    {
        pass1_1030_39dc(param_1, (long *)str_var1(param_6, &param_3), CONCAT13((globals.PTR_LOOP_1050_5f2e >> 0x8), CONCAT12(globals.PTR_LOOP_1050_5f2e, uVar4)), param_2);
    }
    pass1_1000_4906((param_1 & 0xffff0000 | (param_1 + 0x18c)), 0x0, 0x18);
    return;
}
...

{
    ...
    {
        local_4 = 0x5a;
        while((-0x1 < local_4 && (pass1_1030_3a3a(param_1, (long *)str_var1(param_4, &param_3), local_4), param_3 != 0x0)))
        {
            local_4 = local_4 + -0x1;
        }
    }
    ...
    {
        pass1_1030_3948(param_1, str_var1(param_4, &local_4), str_var1(param_4, &local_6), param_2);
        iVar2    = (local_4 - local_6) + 0x1;
        lVar4    = param_3 / (long)iVar2;
        lVar5    = lVar4 * iVar2;
        uVar3    = lVar5;
        uStack18 = str_var1(((param_3 >> 0x10) - (lVar5 >> 0x10)) - (param_3 < uVar3), param_3 - uVar3);
    ...
    pass1_1000_4906((param_1 & 0xffff0000 | (iVar6 + 0x18c)), 0x0, 0x18);
    return;
}
...

{
    ...
    u_stack6 = 0x0;
    pass1_1030_3948(param_1, str_var1(param_3, &local_a), str_var1(param_3, &local_8), param_2);
...
void  pass1_1030_3948(param_1: u32,param_2: *mut u16, i16 *param_3, i16 param_4)
...
void  pass1_1030_39dc(param_1: u32, long *param_2, param_3: u32, i16 param_4)

{
    ...
    pass1_1030_3948(param_1, str_var1(unaff_SS, &local_6), str_var1(unaff_SS, &local_4), param_4);
    iStack8 = local_6;
    while(true)
    {
        if(iStack8 < local_4)
...
void  pass1_1030_3a3a(param_1: u32, long *param_2, i16 param_3)
