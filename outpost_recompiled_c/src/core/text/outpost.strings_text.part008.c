...
/* ── part008 fixup: global aliases & externs ── */
#define _p_GlobalResourceManager p_GlobalResourceManager
extern void        *p_GlobalResourceManager;
extern const char   s__mid_1050_14c0[];
extern const char   s__wav_1050_14ba[];
...
void __stdcall16far Resource_Manager_Update_Path_Type3_Logic(void *this,int id)
{
  ...
  if (local_308[0x0] == '\0')
  {
    ...
    pcStack_30c = (char *)CONCAT22(0x1050,pcStack_30c);
  }
  else
  {
    pcStack_30c = (char *)CONCAT22(unaff_SS,local_308);
  }
  strcat_append((char *)CONCAT22(unaff_SS,local_108),pcStack_30c);
...
void __stdcall16far Resource_Manager_Report_File_Error_Logic(char *filename)
{
  ...
  strcpy_optimized((char *)CONCAT22(unaff_SS,local_402),(char *)CONCAT22(reg_dx,pcVar1));
  strcat_append((char *)CONCAT22(unaff_SS,local_402),in_stack_00000008);
  pcVar1 = Resource_Manager_LoadString_to_Internal_Buffer
                     ((int)_p_GlobalResourceManager,
                      (int)((ulong)_p_GlobalResourceManager >> 0x10),0x57b);
  MessageBox16(0x1010,pcVar1,reg_dx,(ushort)local_402);
