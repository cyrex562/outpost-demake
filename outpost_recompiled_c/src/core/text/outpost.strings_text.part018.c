...
void __stdcall16far UI_Component_Set_String_at_1FA(astruct_154 *param_1,char *param_2)
{
  ...
  *(undefined2 *)((int)&uVar2->field506_0x1fa + 0x2) = reg_dx;
  return;
}
          ...
          (void *param_1,undefined4 param_2,undefined4 param_3)
{
  ...
  uVar7 = 0x1050;
  pvVar2 = (void *)GetProp16((char *)CONCAT22(reg_ax,(char *)s_procHi_1050_5bd7),
                             param_3._2_2_);
  HVar3 = GetProp16((char *)CONCAT22(reg_ax,(char *)s_procLo_1050_5bd0),param_3._2_2_);
  local_6 = CONCAT22(pvVar2,HVar3);
  HVar3 = GetProp16((char *)CONCAT22(reg_ax,(char *)s_thisHi_1050_5be5),param_3._2_2_);
  puVar4 = (undefined4 *)
           GetProp16((char *)CONCAT22(reg_ax,(char *)s_thisLo_1050_5bde),param_3._2_2_);
