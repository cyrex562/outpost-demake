...
/* ── part002 fixup: externs for undeclared globals ───────────────────────── */
extern uint  g_MaxFileHandles;                              /* max open file handles */
extern uint  g_HeapContext;                                 /* heap context base */
extern byte  g_LowLevelHandleTable[20];                    /* low-level handle flags */
extern void *p_SystemIO_Active;                             /* system I/O active ptr */
extern void *PTR_DAT_1050_0000_1050_6064;                   /* DOS seek control ptr */
extern void *p_CurrentHeapContext;                          /* current heap context */
extern byte *PTR_s_ed_in_Op_Op_1050_0028_1050_5f8e;        /* handle info base ptr */
extern uint  g_AllocFlags;                                  /* allocation flags */
extern void *s_A_1050_4202;                                 /* DOS seek AH=0x42 stub */
extern char *s_180_flc_1050_1bfe;                           /* handle / 180.FLC data */

/* forward decl: handle_buffered_write_chunk_internal is defined later in this TU */
u16 __cdecl16near handle_buffered_write_chunk_internal(void);
/* forward decl: defined in a non-graduated file; stub in missing_deps.c */
void handle_low_level_write_dispatch_internal(void);
               ...
               (u16 param_1,uint param_2,uint param_3,uint param_4,uint param_5)
{
  ...
  undefined2 uVar5;
  undefined2 uVar6;
  byte uVar7;                     /* was: undefined1 */
  byte uVar8;                     /* was: undefined1 */
  ...
  if (((param_2 < g_MaxFileHandles) || (p_SystemIO_Active == NULL)) || (0x2 < param_2))
  {
    ...
    if (param_5 != 0x0)
    {
      ...
      {
        pcVar1 = (code *)swi(0x21);
        (*pcVar1)(); /* void return — register result unavailable in flat model */
        CONTEXT_ptr_context = (void *)CONCAT22(uVar6,pvVar3); /* use else-branch expr */
      }
      else
      {
...
LAB_1000_36e3:
      ...
      else
      {
        ...
        {
          pcVar1 = (code *)swi(0x21);
          (*pcVar1)(); uVar9 = CONCAT22(uVar5,uVar6); /* void return; use else-branch fallback */
        }
        else
        {
          Dos3Call(CONTEXT_ptr_context);
...
LAB_1000_3a26:
  ...
  if ((param_2[0x5f90] & 0x20) != 0x0)
  {
    ...
    if (true)
    {
      ...
      (*pcVar2)(); /* void return; pbVar3 unchanged — register result unavailable */
    }
    else
    {
      Dos3Call(CONTEXT_ptr_context);
...
LAB_1000_3acf:
  ...
  bVar14 = true;
  pcStack_6 = NULL;
  { static byte _p002_stack_dummy[8] = {0}; puVar19 = _p002_stack_dummy; } /* was &stack0xffee — 16-bit stack offset N/A in flat model */
  ...
  if (param_4 != 0x0)
  {
    ...
    if (uVar5 < 0xa9)
    {
      ...
      if ((bool)bVar12)
      {
        ...
        {
          pcVar2 = (code *)swi(0x21);
          (*pcVar2)(); pcVar7 = NULL; /* void return; register result unavailable */
          pcVar9 = (char *)pcVar17;
        }
        else
        {
      ...
      pcVar10 = (char *)CONCAT11(cVar16 << 0x7 | cVar15 << 0x6 | flag_af << 0x4 |
    ...
    { static char _p002_write_buf[4] = {0}; /* replaces 16-bit stack buf stack0xffec/0xffee */
      pcVar7 = &_p002_write_buf[1]; /* end-of-buf: was &stack0xffec */
      pcVar9 = &_p002_write_buf[0]; /* write cursor: was &stack0xffee */ }
    do
    {
      pcVar1 = pcVar10;
      pcVar10 = pcVar10 + 0x1;
...
u16 __cdecl16near handle_buffered_write_chunk_internal(void)
{
  ...
  error_code = (void *)(unaff_DI - reg_dx);
  if (error_code == NULL)
  {
    return reg_ax;
  }
  ...
  if ((bool)bVar5)
  {
    uVar2 = CONCAT11(0x40,(char)reg_ax);
    bVar5 = 0x0;
    cVar9 = '\0';
    cVar8 = '\x01';
    cVar7 = '\x01';
    ...
    {
      pcVar1 = (code *)swi(0x21);
      (*pcVar1)(); uVar2 = 0; /* void return; register result unavailable in flat model */
  ...
  uVar3 = CONCAT11(cVar9 << 0x7 | cVar8 << 0x6 | flag_af << 0x4 | cVar7 << 0x2 | 0x2U |
                   bVar5,(char)uVar2);
...
/* NOTE: atoi_wrapper_far defined in outpost.strings_text.part003.c — removed duplicate */
