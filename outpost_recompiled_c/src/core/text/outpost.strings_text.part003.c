...
/* ── part003 fixup: externs for undeclared globals ────────────────────────── */
extern uint       g_MaxFileHandles;
extern uint       g_HeapContext;
extern byte       g_LowLevelHandleTable[20];
extern pointer    p_EnvSegment_Base;
extern pointer    p_EnvOffset_Base;
extern undefined2 g_TimezoneName_Segment;
extern uint       g_TimezoneName_Offset;
extern undefined *g_TimezoneOffset_High;
extern u16        g_TimezoneOffset_Low;
extern u16        u16_1050_61d2;
extern char      *_g_DSTName_Offset;
extern dword      p_StrtokNextToken;
extern undefined *PTR_DAT_1050_0000_1050_5f78;
extern undefined *PTR_DAT_1050_0000_1050_5f88;
extern void      *p_AllocStrategyCode;
extern char      *s_NewFailedMsg;
/* sprintf format buffer globals */
extern undefined  PTR_DAT_1050_0000_1050_68b2;
extern undefined *PTR_DAT_1050_0000_1050_68ae;
extern undefined *PTR_DAT_1050_0000_1050_68b0;
extern byte      *_PTR_DAT_1050_0000_1050_68a8;
extern undefined2 PTR_DAT_1050_0000_1050_68aa;
extern undefined *PTR_DAT_1050_0000_1050_68ac;
/* PTR_DAT_1050_0000_1050_68a8 (no leading _) is the offset-only view of the
   same address as _PTR_DAT_1050_0000_1050_68a8 (full far-ptr). Alias it. */
#define PTR_DAT_1050_0000_1050_68a8 _PTR_DAT_1050_0000_1050_68a8
extern void      *_p_ResourceManager;
extern void      *PTR_DAT_1050_0000_1050_02ec;
/* forward decl: defined later in this TU */
char * __cdecl16far ltoa_integer_to_string_optimized(long value, char *buffer, int radix);
/* forward decls: stubs in missing_deps.c */
void format_string_dispatcher_internal(uint, uint, char *);
void handle_buffered_write_char(uint, undefined **);
long mul_u32_u32_standard(long, long);
int  dos_get_current_drive_number_internal_far(void);
void dos_get_set_file_attributes_internal_far(byte *, void *);
void *heap_alloc_bytes(uint);
void UI_Save_As_Game_Logic(void *);
void UI_Prompt_Save_Game_Dialog(void *, char *);
void check_error_flag_and_set_internal_err_u8_2(byte, u16, bool);
...
char * __cdecl16far getenv_wrapper_far_ptr_search(char *var_name)
{
  ...
  int *uStack_8;  /* was: undefined4 — promoted to int* for far-ptr pair */
     ...
     (in_stack_00000006 != 0x0 || var_name != NULL))
  {
    ...
    while( true )
    {
      ...
      if (((uVar1 < uVar2) && (*(char *)((int)*uStack_8 + uVar1) == '='))
...
int __cdecl16far
sprintf_wrapper(byte *param_1,undefined *param_2,char *param_3,undefined2 param_4)
{
  byte *puVar1;
  byte *puVar2;
  ...
  PTR_DAT_1050_0000_1050_68b2 = 0x42;  /* ._0_1_ = first byte */
  PTR_DAT_1050_0000_1050_68ae = param_1;
  PTR_DAT_1050_0000_1050_68b0 = param_2;
  _PTR_DAT_1050_0000_1050_68a8 = (byte *)CONCAT22(param_2,param_1);
  PTR_DAT_1050_0000_1050_68ac = (undefined *)0x7fff;
  puVar2 = (byte *)(&param_4 + 1);  /* stack0x000c: varargs start after param_4 */
...
void __cdecl16far parse_tz_environment_variable_internal_far(void)
{
  ...
  undefined2 uVar8;
  undefined2 uVar9;
  char *uStack_8;  /* was: undefined4 — promoted to char* for far-ptr string tracking */
  
  pcVar2 = getenv_wrapper_far_ptr_search((char *)0x61ca);
  uStack_8 = (char *)CONCAT22(reg_dx,pcVar2);
  if ((reg_dx != 0x0 || pcVar2 != NULL) && (*uStack_8 != '\0'))
  {
    strncpy_fixed_optimized
              ((char *)CONCAT22(g_TimezoneName_Segment,g_TimezoneName_Offset),
               (char *)CONCAT22(reg_dx,pcVar2),0x3);
    uStack_8 = (char *)CONCAT22(reg_dx,pcVar2 + 0x3);
    cVar1 = *uStack_8;
    if (cVar1 == '-')
    {
      uStack_8 = (char *)CONCAT22(reg_dx,pcVar2 + 0x4);
    }
    uVar5 = 0x0;
    uVar8 = 0x0;
    uVar7 = 0xe10;
    ...
    if (*uStack_8 == ':')
    {
      ...
      uVar9 = 0x0;
      uVar8 = 0x3c;
      uStack_8 = (char *)uStack_8 + 0x1;  /* flat: advance ptr past ':' (._0_2_ removed) */
      iVar3 = atoi_wrapper_far((char *)uStack_8);
      ...
      if (*uStack_8 == ':')
      {
        uStack_8 = (char *)uStack_8 + 0x1;  /* flat: advance ptr (._0_2_ removed) */
        ...
        while ((lVar6 = CONCAT22(g_TimezoneOffset_High +
               ...
               (lVar6 = CONCAT22(g_TimezoneOffset_High +
                                 ...
                                 g_TimezoneOffset_Low + uVar4), *uStack_8 < ':')))
        {
          uStack_8 = (char *)uStack_8 + 0x1;  /* flat: advance ptr (._2_2_ removed) */
        }
      }
    }
    g_TimezoneOffset_High = (undefined *)((ulong)lVar6 >> 0x10);
...
char * __cdecl16far strchr_far_optimized(char *str,char character)
{
  ...
  uint uVar2;
  char *pcVar3;
  /* undefined2 uVar4; */  /* removed: only used in far-ptr CONCAT artifact below */
  bool bVar5;
  byte in_stack_00000007;  /* far-ptr segment byte — unused in flat model */
  char in_stack_00000008;
  
  /* _str = CONCAT13(in_stack_00000007,CONCAT12(character,str)); */  /* far-ptr not needed flat */
  /* uVar4 = (undefined2)((ulong)_str >> 0x10); */  /* removed with above */
  (void)in_stack_00000007;
  bVar5 = true;
  uVar2 = 0xffff;
  pcVar3 = str;
  do
...
LAB_1000_483c:
  ...
  p_StrtokNextToken = (dword)(uintptr_t)pbVar4;  /* flat: segment half irrelevant */
  UNLOCK();
  return pcVar3;
}
...
// Supports custom base `reg_cx` (e.g., 10 for decimal, 16 for hex) and signs if `reg_bl`
...
char * __cdecl16far ltoa_integer_to_string_optimized(long value,char *buffer,int radix)
{
  ...
  pbVar7 = unaff_DI;
  pbVar6 = unaff_DI;
  if (((reg_bl != '\0') && (reg_cx == 0xa)) && ((int)reg_dx < 0x0))
  {
    pbVar7 = unaff_DI + 0x1;
    *unaff_DI = 0x2d;
    bVar9 = reg_ax != 0x0;
  ...
  do
  {
    ...
    uVar1 = CONCAT22(uVar5,reg_ax);
    reg_ax = (int)(uVar1 / reg_cx);
    cVar3 = (char)(uVar1 % (ulong)reg_cx);
    bVar2 = cVar3 + 0x30;
    if (0x39 < bVar2)
    {
      bVar2 = cVar3 + 0x57;
...
int __cdecl16far dos_set_current_drive_internal_far_check_success(int drive_num)
{
  ...
  if (true)
  {
    ...
    (*pcVar1)();  /* void: swi() result unavailable in flat model */
  }
  else
  {
  ...
  {
    pcVar1 = (code *)swi(0x21);
    (*pcVar1)();  /* void: drive verify result dropped — cVar2 unmodified */
  }
  else
  {
    Dos3Call(CONTEXT_ptr_context);
...
dos_get_cwd_internal_far_with_alloc_logic(int drive_num,char *buffer,int max_len)
{
  ...
  local_4 = 0x1050;
  pcStack_130 = (char *)CONCAT22(unaff_SS,local_108);
  if (drive_num == 0x0)
  {
    drive_num = dos_get_current_drive_number_internal_far();
  }
  *pcStack_130 = (char)drive_num + '@';
  local_108[0x1] = 0x3a;
