...
/* ── part007 fixup: global aliases & externs ── */
#include <outpost.types_structs.part077.h>
#define _p_GlobalResourceManager p_GlobalResourceManager
#define Configuration_Manager_Write_Indexed_Values_Logic switchD_1010_2ab5_Configuration_Manager_Write_Indexed_Values_Logic
...
extern const char      s_off_1050_13c8[];
extern const char      s_on_1050_13c4[];
extern const char      s_falseMap_1050_13de[];
extern const char      s_rez_1050_13c0[];
extern const char      s_anims_1050_13cc[];
extern const char      s_music_1050_13d2[];
extern const char      s_sound_1050_13d8[];
extern const char      s_movies_1050_13e8[];
extern const char      s_turns_1050_1466[];
extern const char      s_turnsDlgStatus_1050_146c[];
extern const char      s_savePath_1050_147c[];
extern const char      s_aiName_1050_1486[];
extern const char      s_playerName_1050_148e[];
extern const char      s_general_1050_13b0[];
extern void           *PTR_s_unknown_1050_13fa_1050_1446[];
extern void           *PTR_DAT_1050_24ea_1050_2526[];
/* Forward declarations for functions defined later in this TU (prevent C89 implicit int) */
...
Configuration_Manager_ctor_init_6312_Logic(void *this,int segment,int id)
{
  ...
  *(uint *)((int)this + 0x10) = reg_dx;
  dos_get_cwd_on_current_drive_wrapper_far
            ((char *)*(undefined2 *)((int)this + 0xe),reg_dx);
  ...
  *(uint *)((int)this + 0xc) = reg_dx;
  ...
  if (*(char *)*(undefined4 *)((int)this + 0xe) != '\0')
  {
    ...
    uVar6 = 0x0;
    uStack_2c = reg_dx;
    if (reg_dx != 0x0 || pcStack_2e != NULL)
    {
      *(int *)((int)this + 0x76) = (int)pcStack_2e;
      *(uint *)((int)this + 0x78) = reg_dx;
      uVar6 = reg_dx;
    }
  }
  GetPrivateProfileString16
  ...
  paStack_32 = (astruct_491 *)CONCAT22(uVar6,this_00);
  ...
  *(uint *)((int)this + 0x66) = uVar7;
  ...
  paStack_32 = (astruct_491 *)CONCAT22(uVar7,puVar5);
  ...
  {
    *(char **)paStack_32 = (char *)s_1_1050_389a;
    puVar5[0x1] = 0x1008;
    *(char **)(puVar5 + 0x2) = uStack_10;
    *(undefined2 *)paStack_32 = 0x6322;
    puVar5[0x1] = 0x1010;
    puStack_14 = (undefined2 *)paStack_32;
  }
  ...
  if (*(char *)*(undefined4 *)((int)this + 0xe) != '\0')
  {
          ...
          uVar6 != 0x0 || pcStack_2e != NULL)
    {
      ...
      puVar5 = allocate_memory(CONCAT22(uVar9,0x8));
      paStack_32 = (astruct_491 *)CONCAT22(uVar6,puVar5);
...
void __stdcall16far Configuration_Manager_dtor_6312_Logic(void *this)
{
  ...
  *(undefined2 *)((int)this + 0x2) = 0x1010;
  ...
  do
  {
    Configuration_Manager_Write_Indexed_Values_Logic
...
void __stdcall16far UI_Component_Set_String_at_Offset_12_Logic_2(void *this,char *str)
{
  ...
  *(undefined2 *)((int)this + 0x14) = reg_dx;
  return;
}
...
void __stdcall16far UI_Component_Set_String_at_Offset_68_Logic(void *this,char *str)
{
  ...
  *(undefined2 *)((int)this + 0x6a) = reg_dx;
  return;
}
...
void __stdcall16far UI_Component_Set_String_at_Offset_6C_Logic(void *this,char *str)
{
  ...
  *(undefined2 *)((int)this + 0x6e) = reg_dx;
  return;
}
...
int __stdcall16far Resource_Manager_Update_Path_by_Type_Logic(void *this,int mode)
{
  ...
  if ((pcVar1 == local_106) && (reg_dx == unaff_SS))
  {
    Resource_Manager_Report_File_Error_Logic(this);
  }
  free_if_not_null(*(void **)this);
  pcVar1 = strdup_allocate(pcVar1);
  *(int *)this = (int)pcVar1;
  *(int *)((int)this + 0x2) = reg_dx;
  return *(int *)this;
}
