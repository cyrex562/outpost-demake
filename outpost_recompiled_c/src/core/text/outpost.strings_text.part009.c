 ...
 * Theme: strings_text
 * Chunk: 9/19
 * Original lines (combined): 38655-40245
 * Boundaries: top-level declarations/definitions only
 */

/* ── part009 fixup: global aliases & externs ── */
...
extern pointer         _p_StringPropertyTable;
extern void           *_p_ResourceManager;
extern uint            g_HeapContext;
extern void           *p_CurrentHeapContext;
extern char            s__lu_1050_381f[];
extern void           *p_SmallBlockFreeList;
extern void           *PTR_DAT_1048_0000_1048_3820;
extern const char      s_HeapVersion[];
extern undefined      *g_ModeVersion_13AE;

static undefined1      stack0xfffe[8];
static undefined1      stack0xffbc[8];

#define FIELD_LO16(v)   (*(uint16_t *)&(v))
#define FIELD_HI16(v)   (*(uint16_t *)((char *)&(v) + 2))
#define FIELD_BYTE0(v)  (*(uint8_t  *)&(v))
#define FIELD_BYTE1(v)  (*(uint8_t  *)((char *)&(v) + 1))
...
UI_Generate_Formatted_Label_Logic(int offset,int segment,char *format_id)
{
  ...
  uVar37 = 0x0;
  FIELD_LO16(uStack_e) = NULL;
  FIELD_HI16(uStack_e) = NULL;
  pvStack_10 = NULL;
  if ((char *)CONCAT22(in_stack_0000000a,format_id) != NULL)
  {
    ...
    FIELD_LO16(uStack_e) = (dword *)pcVar21;
    iVar25 = (int)((ulong)pcVar29 >> 0x10);
    FIELD_HI16(uStack_e) = (void *)iVar25;
  ...
  if (in_stack_0000000c == 0x177e)
  {
    uStack_28 = (undefined **)
                UI_Get_Entity_Property_by_Array_Index_Logic
                          (CONCAT13(FIELD_BYTE1(segment),CONCAT12((undefined1)segment,offset)),
                           0x10);
...
code_r0x1010709b:
              ...
              case 0x5:
                ...
                if (CONCAT11(FIELD_BYTE0(format_id),FIELD_BYTE1(segment)) == 0x2)
                {
              ...
              case 0x7:
                ...
                ppuStack_8 = Bitmap_Object_Copy_Region_To_New_Bitmap
                                        ...
                                        *(int *)(iVar36 + 0x3386),
                                        *(int *)(iVar36 + 0x3384));
                FIELD_HI16(uStack_e) = (void *)*(void **)(format_id + 0x14);
                pcStack_a = (char *)((ulong)*(void **)(format_id + 0x14) >> 0x10);
                pdStack_6 = height;
                pvStack_10 = get_with_lazy_init(FIELD_HI16(uStack_e));
                FIELD_LO16(uStack_e) = height;
                ...
                uStack_28 = (undefined **)CONCAT22(FIELD_HI16(uStack_28),height);
              ...
              case 0xd:
                ...
                FIELD_LO16(uStack_e) = (dword *)((ulong)lVar32 >> 0x10);
...
LAB_1010_a153:
                      uStack_1c = (undefined **)
                                  CONCAT22(FIELD_HI16(uStack_1c),
                                           (undefined **)
                                           (*(int *)(local_16 + 0x6) /
                                           (int)FIELD_HI16(uStack_e)));
                      *(int *)(local_16 + 0x6) =
                           *(int *)(local_16 + 0x6) -
                           *(int *)(local_16 + 0x6) / (int)FIELD_HI16(uStack_e);
                    }
                  }
                  ...
                  *(int *)(local_16 + 0x6) = *(int *)(local_16 + 0x6) - (int)ppuVar10;
                  ...
                  UI_Object_Add_Type_Value_Pair_to_Collection_at_Offset_12_Logic
                            ((void *)offset,
                             (int)(CONCAT13(FIELD_BYTE1(segment),
    ...
    if (in_stack_0000000c == 0x1775)
    {
      ...
      uStack_28 = (undefined **)CONCAT22(FIELD_HI16(uStack_28),ppuVar12);
    ...
    if (in_stack_0000000c < 0x1776)
    {
      ...
      if (in_stack_0000000c == 0x1771)
      {
        ppuVar30 = (undefined **)
                   UI_Entity_Calculate_Total_Property_Value_Logic
                             (CONCAT22((int)(CONCAT13(FIELD_BYTE1(segment),
      ...
      else
      {
        ...
        UI_Entity_Get_Two_Related_Values_Logic
                  ((int *)offset,
                   (int *)(CONCAT13(FIELD_BYTE1(segment),CONCAT12((undefined1)segment,offset))
    ...
    case 0x1776:
      ...
      uStack_24 = (undefined **)CONCAT22(FIELD_HI16(uStack_24),ppuVar12);
      if (ppuVar12 == NULL)
      {
LAB_1010_b686:
        uVar37 = 0x531;
    ...
    case 0x1777:
          ...
          uStack_1c = (undefined **)((long)uStack_1c + 0x1))
      {
        ...
        if (iVar25 != 0x0)
        {
          uStack_28 = (undefined **)CONCAT22(FIELD_HI16(uStack_28),(undefined **)0x1);
          break;
        }
      }
      if (uStack_24 != NULL)
...
LAB_1010_b2d4:
    ...
    case 0x177b:
      UI_Get_Nested_Collection_Value_Logic
                (CONCAT13(FIELD_BYTE1(segment),CONCAT12((undefined1)segment,offset)),0xd);
      break;
    case 0x177c:
      UI_Get_Nested_Collection_Value_Logic
                (CONCAT13(FIELD_BYTE1(segment),CONCAT12((undefined1)segment,offset)),0x27);
      break;
    case 0x177d:
      uStack_28 = (undefined **)
                  UI_Get_Entity_Property_by_Array_Index_Logic
...
switchD_1010_be17_default:
  ...
  case 0x1782:
    UI_Get_Nested_Collection_Value_Logic
              (CONCAT13(FIELD_BYTE1(segment),CONCAT12((undefined1)segment,offset)),0x6);
    break;
  case 0x1783:
    break;
  case 0x1784:
  ...
  case 0x1786:
    UI_Get_Nested_Collection_Value_Logic
              (CONCAT13(FIELD_BYTE1(segment),CONCAT12((undefined1)segment,offset)),0xe);
    break;
  case 0x1787:
    ...
    uStack_20 = (undefined **)CONCAT22(FIELD_HI16(uStack_20),ppuVar12);
LAB_1010_b146:
    sprintf_wrapper();
    goto switchD_1010_becf_caseD_1826;
  default:
...
switchD_1010_be17_caseD_1778:
  ...
  case 0x178a:
    pcVar15 = UI_Entity_Get_SubCategory_Name_Logic
                        ((char *)offset,(long)CONCAT22(FIELD_HI16(uStack_e),(dword *)uStack_e)
                        );
    goto LAB_1010_b188;
  case 0x1794:
    uVar37 = 0x64c;
...
LAB_1010_b18a:
  ...
  case 0x1796:
    UI_Get_Nested_Collection_Value_Logic_Alt
              (CONCAT13(FIELD_BYTE1(segment),CONCAT12((undefined1)segment,offset)),0x2);
  }
LAB_1010_b1f5:
  sprintf_wrapper();
