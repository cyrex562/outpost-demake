...
void handle_update_error_state_wrapper_void(void)
{
  ...
  check_error_flag_and_set_internal_err_void
            (*(u16 *)(*(int *)(reg_bp + -0xa) + 0x4),
             *(uint *)(reg_bp + -0x4) < *(uint *)(reg_bp + -0x6));
  return;
}
...
LAB_1000_41aa:
    ...
    iVar2 = (*(code *)p_GlobalAllocHook_Callback)(reg_cs,param_3,param_1,param_2);
    if (iVar2 == 0x0)
    {
      return reg_si;
    }
...
int __cdecl16far dos_get_set_file_attributes_internal_far(void *regs_in,void *regs_out)
{
  ...
  {
    Dos3Call((dword *)CONCAT22(reg_di,(dword *)&g_HeapContext));
...
void __cdecl16far dos_get_system_time_to_internal_struct_far(void *time_struct)
{
  ...
  pvVar5 = (void *)CONCAT22(0x1050,reg_si);
  if (true)
  {
  ...
  if (true)
  {
    pcVar1 = (code *)swi(0x21);
    (*pcVar1)();
    time_dx = extraout_DX_01;
  }
  else
  {
    Dos3Call(pvVar5);
  }
  if ((uVar4 != time_dx) && ((char)pvVar5 == '\x17'))
  {
    uVar3 = time_cx;
    time_dx = uVar4;
  }
  uVar6 = CONCAT22((int)((ulong)pvVar5 >> 0x10),time_dx) & 0xffff00ff;
  iVar2 = convert_datetime_to_unix_timestamp_internal_far_maybe
                    (uVar3 - 0x7bc,time_dx >> 0x8,(int)uVar6,(int)(uVar6 >> 0x10),min,sec)
  ;
  if (in_stack_00000006 != 0x0)
  {
    *(uint *)((int)time_struct + 0x2) = time_dx;
    *_time_struct = iVar2;
  }
  return;
}
