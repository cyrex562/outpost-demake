...
{
    Polygon16(hdc, count_and_points, (short)((unsigned long)count_and_points >> 16));
}
...
// Win16 artifact: `in_stack_00000006` was the segment half of the far `this_ptr`
// at [BP+6]; flat model uses a single near pointer. Removed.
// Typo fix: `*_this_ptr` (bad global ref) -> `this_ptr[0]` (first element of array).
u32 * __stdcall16far
