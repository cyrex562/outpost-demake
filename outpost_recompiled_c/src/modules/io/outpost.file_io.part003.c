...
UI_Object_Collection_Deserialize_from_File_bb5e(u32 param_1,void *param_2)
{
  ...
  else
  {
       ...
       (iVar3 = file_read_check((long)param_2,&local_10,unaff_SS), iVar3 != 0x0))
    {
      ...
      {
        pvVar4 = construct_object_with_vtable(this,alloc_seg);
      }
  ...
  if (iVar2 != 0x0)
  {
    ...
    if (iVar2 != 0x0)
    {
      ...
      while( true )
      {
        ...
        handle_wrapper = (void *)(alloc_seg | (uint)pvVar3);
  ...
  else
  {
    ...
    if (iVar2 != 0x0)
    {
      ...
      while( true )
      {
        ...
        local_1a = CONCAT22(alloc_seg,pvVar4);
  ...
  if (path_bitmask != 0x0)
  {
    ...
    else
    {
      ...
      uVar4 = UI_TreeNode_Control_ctor_init_c54a
                        (pvVar3,alloc_seg,0x1,uStack_8,*(undefined2 *)((int)this + 0x22));
    }
