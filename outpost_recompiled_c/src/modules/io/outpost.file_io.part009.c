      ...
      *(undefined2 *)(iVar7 + 0x1c) = local_8;
         ...
         iVar3 != 0x0))
      {
        if ((int)PTR_DAT_1050_0000_1050_0312 < 0x2)
        {
          ...
          iVar3 = file_read_check((long)param_2,buffer,alloc_seg);
          if (iVar3 == 0x0)
          {
LAB_1038_626a:
            g_LastFileErrorMsgID = (undefined *)0x6d2;
        ...
        if (pcVar4 != NULL)
        {
          ...
          *(undefined2 *)(iVar7 + 0x1fc) = alloc_seg;
...
Simulator_Complex_Collection_Load_from_File_7c02(undefined4 *param_1,void *param_2)
{
  ...
  {
LAB_1038_7c0d:
  return (void *)CONCAT22(0x1,alloc_seg);
  }
     ...
     (iVar2 = file_read_check((long)param_2,&local_4,unaff_SS), iVar2 != 0x0))
  {
    while( true )
    {
      ...
      else
      {
        pvStack_e = Simulator_Resource_Change_Item_ctor_init_6520
                              ((void *)CONCAT22(alloc_seg,pvVar3));
      }
      alloc_seg = (void *)((ulong)pvStack_e >> 0x10);
    ...
    if (iVar2 != 0x0)
    {
      while (local_12[0x0] != 0x0)
      {
        ...
        if (alloc_seg == NULL && pvVar4 == NULL)
        {
          this_ptr = NULL;
        }
        else
        {
          this_ptr = UI_Component_Type_B932_ctor_ae6c((void *)CONCAT22(alloc_seg,pvVar4));
        }
        alloc_seg = (void *)((ulong)this_ptr >> 0x10);
