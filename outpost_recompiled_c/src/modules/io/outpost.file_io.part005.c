    ...
    if (iVar2 != 0x0)
    {
      ...
      if (local_4 != 0x0)
      {
        if (*(long *)(iVar2 + 0xa) == 0x0)
        {
          ...
          local_16 = CONCAT22(alloc_seg,paVar3);
          uVar7 = alloc_seg | (uint)paVar3;
          if (uVar7 == 0x0)
          {
          ...
          {
            pvVar4 = construct_object_with_vtable(paVar3,alloc_seg);
        ...
        for (local_12 = 0x0; local_12 < local_4; local_12 += 0x1)
        {
          ...
          local_16 = CONCAT22(alloc_seg,pvVar4);
...
LAB_1010_9c32:
      ...
      if (iVar5 != 0x0)
      {
        if (local_2a != 0x0)
        {
          ...
          {
            paVar3 = allocate_memory(CONCAT22(in_stack_0000ffc4,0xc));
            local_2e = CONCAT22(alloc_seg,paVar3);
            uVar7 = alloc_seg | (uint)paVar3;
            if (uVar7 == 0x0)
            {
    ...
    if (iVar3 != 0x0)
    {
      ...
      if (iVar3 != 0x0)
      {
        ...
        while( true )
        {
          ...
          local_1c = (undefined2 *)CONCAT22(alloc_seg,puVar4);
