...
void __stdcall16far UI_Component_OnPaint_Render_Internal_Bitmap_logic_e16c(long context)
{
  ...
  local_24 = BeginPaint16((undefined1 *)CONCAT22(reg_ss,local_22),uVar5->field4_0x4);
  ...
  EndPaint16((undefined1 *)CONCAT22(reg_ss,local_22),uVar5->field4_0x4);
  return;
}
...
void __stdcall16far UI_Component_Default_OnPaint_Handler_0c3e(long context)
{
  ...
  iVar5 = (int)context;
  local_24 = BeginPaint16((undefined1 *)CONCAT22(reg_ss,local_22),
                          *(HWND16 *)(iVar5 + 0x4));
  ...
  EndPaint16((undefined1 *)CONCAT22(reg_ss,local_22),*(HWND16 *)(iVar5 + 0x4));
  return;
}
...
void __stdcall16far UI_Status_Icon_Draw_Logic(long context)
{
  ...
  if (p_FreeBlockListHead == NULL)
  {
    ...
    if (HStack_4 != 0x0)
    {
      ...
      GetClientRect16((undefined1 *)CONCAT22(reg_ss,local_e),uVar2->field4_0x4);
      hdc = (HDC16)((u32 *)uVar2->field19_0x14)[0x1f];
      FillRect16(HStack_6,(void *)CONCAT22(hdc,reg_ss),(HDC16)hdc_00);
...
UI_Draw_Centering_Indicator_Triangle_Alternative_239c(void *hdc_state,int *rect_coords)
{
  ...
  if (_rect_coords != NULL)
  {
    ...
    pack_3words_alt(local_a,reg_ss,0x0,0x57);
    puVar1 = local_a;
    hdc = UI_Build_3Point_Triangle_Coordinate_Array_Alternative_23f2
            (hdc_state,puVar1,reg_ss);
...
GDI_Polygon_Wrapper_3602(u16 unused1,u16 unused2,void *count_and_points,HDC16 hdc)
{
  ...
  Polygon16(reg_cs,(void *)count_and_points,(short)((ulong)count_and_points >> 0x10));
  return;
}
...
void __stdcall16far UI_SubComponent_Grid_Draw_Logic_9364(void *this_ptr)
{
  ...
  GetClientRect16((undefined4 *)CONCAT22(reg_ss,&local_a),uVar4->field4_0x4);
  local_12 = local_a;
  uStack_e = uStack_6;
  ...
  do
  {
    ...
    MoveToEx16((HDC16)local_38,(short)reg_ss,((undefined2 *)puStack_1a)[uStack_3a],
               (void *)local_a);
    LineTo16(((undefined2 *)puStack_1a)[uStack_3a],(short)uStack_6,HStack_30);
    iVar5 = uStack_14 - uStack_3a;
    MoveToEx16((HDC16)local_38,(short)reg_ss,((undefined2 *)puStack_1a)[iVar5],
               (void *)local_a);
  ...
  FillRect16(HVar3,(void *)CONCAT22(HStack_30,reg_ss),hdc);
  ...
  do
  {
    ...
    MoveToEx16((HDC16)local_38,(short)reg_ss,
    ...
    pvVar4 = (void *)(*(int *)((uStack_16 - uStack_3a) * 0x2 + (int)(void *)pvStack_2a)
                     + (int)(void *)local_a);
    MoveToEx16((HDC16)local_38,(short)reg_ss,((undefined2 *)puStack_1a)[*piVar1],
               pvVar4);
    LineTo16(((undefined2 *)puStack_1a)[uStack_14 - *piVar1],(short)pvVar4,HStack_30);
    SelectObject16(0x1538,HStack_34);
    DeleteObject16(HStack_32);
...
undefined2 __stdcall16far UI_SubDialog_Type20D4_OnPaint_Logic_21d6(undefined4 param_1)
{
  ...
  iVar9 = (int)param_1;
  local_24 = (void *)BeginPaint16((undefined1 *)CONCAT22(reg_ss,local_22),
                                  *(HWND16 *)(iVar9 + 0x6));
  ...
  EndPaint16((undefined1 *)CONCAT22(reg_ss,local_22),*(HWND16 *)(iVar9 + 0x6));
  return 0x1;
}
