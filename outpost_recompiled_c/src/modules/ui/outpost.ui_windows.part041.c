  ...
  else
  {
    puVar2 = (undefined4 *)
             UI_SubDialog_Type8DDC_ctor_VarArgs_Logic_8520
                       (pvStack_10,reg_dx,uVar5->field6_0x6,0x4,0x3,0x634,0x726,0x727);
  }
          ...
          (undefined4 param_1,undefined2 param_2,undefined2 param_3,undefined2 param_4)
{
  ...
  if (iStack_4 != 0x0)
  {
    ...
    else
    {
      ...
      puVar3 = (undefined4 *)
               UI_SubDialog_Type8DDC_ctor_VarArgs_Logic_8520
                         (pvVar2,reg_dx,*(undefined2 *)((int)param_1 + 0x6),0x0,0x6340002
                          ,iStack_4);
    }
