 ...
 * Theme: ui_windows
 * Chunk: 37/54
 * Original lines (combined): 115562-116406
...
void __stdcall16far UI_SubDialog_TypeA428_Show_Logic_a396(void *param_1)
{
  ...
  *(undefined2 *)((int)this_ptr + 0x8c) = reg_ax;
...
void __stdcall16far UI_SubDialog_TypeA62E_Show_Logic_a4ee(void *this_ptr)
{
  ...
  *(undefined2 *)((int)this_ptr_00 + 0x8c) = reg_ax;
...
void * __stdcall16far UI_SubDialog_Manager_ctor_init_aeca(void *param_1)
{
  ...
  *(undefined2 *)((int)dest + 0xae) = 0x0;
  ...
  UI_OPButton_ctor_9854(&local_b6); /* CONCAT22(unaff_SS,&local_b6) -> flat: drop SS segment */
  local_b6 = 0x389a;
  local_b4 = 0x1008;
