 ...
 * Theme: ui_windows
 * Chunk: 38/54
 * Original lines (combined): 116407-117361
...
LAB_1038_afa0:
      ...
      else
      {
        puVar10 = UI_SubDialog_TypeA0B6_ctor_init_9f76
                            ((void *)CONCAT22(reg_dx,pvVar5),0x0,0x0,0x0,arg2);
      }
      break;
    case 0x2:
      pvVar5 = allocate_memory(CONCAT22(unaff_SI,0x96));
      uVar6 = (uint)reg_dx | (uint)pvVar5;
    ...
    case 0x3:
      ...
      if (reg_dx == NULL && pvVar5 == NULL) goto LAB_1038_afa0;
    ...
    case 0x8:
      ...
      if (reg_dx == NULL && pvVar5 == NULL) goto LAB_1038_afa0;
      puVar10 = UI_SubDialog_TypeBD70_ctor_init_b772(pvVar5,reg_dx,0x0,0x0,0x0,arg2);
      break;
    case 0x9:
      unaff_CS = 0x1000;
      pvVar5 = allocate_memory(CONCAT22(unaff_SI,0x8e));
    ...
    case 0xa:
      ...
      puVar10 = UI_SubDialog_TypeA428_ctor_init_a33c
                          ((void *)CONCAT22(reg_dx,pvVar5),arg2);
      break;
    case 0xb:
      unaff_CS = 0x1000;
      pvVar5 = allocate_memory(CONCAT22(unaff_SI,0x90));
      uVar6 = (uint)reg_dx | (uint)pvVar5;
      if (uVar6 == 0x0) goto LAB_1038_afa0;
      puVar4 = UI_SubDialog_TypeA62E_ctor_init_a494((void *)CONCAT22(reg_dx,pvVar5),arg2)
      ;
      puVar10 = (u16 *)CONCAT22(uVar6,puVar4);
      break;
    case 0xc:
    ...
    case 0x11:
      ...
      if (reg_dx == NULL && puVar4 == NULL) goto LAB_1038_afa0;
      unaff_CS = 0x1040;
    ...
    case 0x14:
      ...
      if (uVar6 == 0x0) goto LAB_1038_afa0;
      unaff_CS = 0x1040;
      puVar4 = (u16 *)UI_SubDialog_Type237E_ctor_init_1f5a(pvVar5,(ushort)reg_dx);
      puVar10 = (u16 *)CONCAT22(uVar6,puVar4);
      break;
    case 0x15:
      unaff_CS = 0x1000;
    ...
    case 0x16:
      ...
      uVar6 = (uint)reg_dx | (uint)pvVar5;
      if (uVar6 == 0x0) goto LAB_1038_afa0;
      puVar4 = (u16 *)UI_SubDialog_Type067C_ctor_init_eeda(pvVar5,(ushort)reg_dx);
      puVar10 = (u16 *)CONCAT22(uVar6,puVar4);
      break;
    case 0x17:
      pvVar5 = allocate_memory(CONCAT22(unaff_SI,0x96));
      ...
      puVar10 = (u16 *)UI_Allocation_Tab_Manager_ctor_init_logic
                                 ((long)CONCAT22(reg_dx,pvVar5),arg2);
      break;
    default:
    ...
    case 0x1a:
      ...
      if (uVar6 == 0x0) goto LAB_1038_afa0;
      unaff_CS = 0x1040;
      puVar4 = (u16 *)UI_SubDialog_Type17B0_ctor_init_123e(pvVar5,reg_dx,0x0,0x0,0x0);
      puVar10 = (u16 *)CONCAT22(uVar6,puVar4);
      break;
    case 0x1b:
      unaff_CS = 0x1000;
    ...
    case 0x1d:
      ...
      uVar6 = (uint)reg_dx | (uint)pvVar5;
      if (uVar6 == 0x0) goto LAB_1038_afa0;
      puVar4 = UI_SubDialog_TypeEE6E_ctor_init_eb9e(pvVar5,(ushort)reg_dx);
      puVar10 = (u16 *)CONCAT22(uVar6,puVar4);
      break;
    case 0x1e:
      unaff_CS = 0x1000;
    ...
    case 0x20:
      ...
      if (uVar6 == 0x0) goto LAB_1038_afa0;
      unaff_CS = 0x1040;
      puVar4 = (u16 *)UI_SubDialog_Type3436_ctor_init_2ea2(pvVar5,reg_dx,0x0,0x0,0x0);
      puVar10 = (u16 *)CONCAT22(uVar6,puVar4);
      break;
    case 0x21:
      ...
      if (uVar6 == 0x0) goto LAB_1038_afa0;
      unaff_CS = 0x1040;
      puVar4 = (u16 *)UI_Trade_Request_Dialog_ctor_init_3966(pvVar5,reg_dx,0x0,0x0,0x0);
      puVar10 = (u16 *)CONCAT22(uVar6,puVar4);
      break;
    case 0x22:
      pvVar5 = allocate_memory(CONCAT22(unaff_SI,0x9a));
      ...
      if (uVar6 == 0x0) goto LAB_1038_afa0;
      unaff_CS = 0x1040;
      puVar4 = (u16 *)UI_SubDialog_Type38FA_ctor_init_34a2(pvVar5,reg_dx,0x0,0x0,0x0);
      puVar10 = (u16 *)CONCAT22(uVar6,puVar4);
      break;
    case 0x23:
      pvVar5 = allocate_memory(CONCAT22(unaff_SI,0x9c));
    ...
    case 0x25:
      ...
      if (uVar6 == 0x0) goto LAB_1038_afa0;
      unaff_CS = 0x1040;
      puVar4 = (u16 *)UI_SubDialog_TypeD07C_ctor_init_ca16(pvVar5,(ushort)reg_dx);
      puVar10 = (u16 *)CONCAT22(uVar6,puVar4);
      break;
    case 0x26:
      this_ptr = allocate_memory(CONCAT22(unaff_SI,0xa2));
      uVar6 = (uint)reg_dx | (uint)this_ptr;
      if (uVar6 == 0x0) goto LAB_1038_afa0;
      unaff_CS = 0x1040;
      puVar4 = (u16 *)UI_SubDialog_TypeD8C4_ctor_init_d0f8(this_ptr,(ushort)reg_dx,arg2);
      puVar10 = (u16 *)CONCAT22(uVar6,puVar4);
      break;
    case 0x27:
      unaff_CS = 0x1000;
      ...
      uVar6 = (uint)reg_dx | (uint)pvVar5;
      if (uVar6 == 0x0) goto LAB_1038_afa0;
      puVar4 = UI_Transfer_Dialog_ctor_init_88f2((void *)CONCAT22(reg_dx,pvVar5),arg2);
      puVar10 = (u16 *)CONCAT22(uVar6,puVar4);
      break;
    case 0x28:
      pvVar5 = allocate_memory(CONCAT22(unaff_SI,0x96));
      ...
      if (uVar6 == 0x0) goto LAB_1038_afa0;
      unaff_CS = 0x1040;
      puVar4 = (u16 *)UI_SubDialog_Type67BA_ctor_init_6402(pvVar5,(ushort)reg_dx);
      puVar10 = (u16 *)CONCAT22(uVar6,puVar4);
      break;
    case 0x29:
      unaff_CS = 0x1000;
      puVar4 = allocate_memory(CONCAT22(unaff_SI,0x98));
      uVar6 = (uint)reg_dx | (uint)puVar4;
      if (uVar6 == 0x0) goto LAB_1038_afa0;
      puVar4 = UI_SubDialog_Type8876_ctor_init_7d10(puVar4,(uint16_t)reg_dx);
      puVar10 = (u16 *)CONCAT22(uVar6,puVar4);
      break;
    case 0x2a:
      unaff_CS = 0x1000;
      ...
      if (reg_dx == NULL && pvVar5 == NULL) goto LAB_1038_afa0;
      puVar10 = UI_SubDialog_Type90C8_ctor_init_8caa((void *)CONCAT22(reg_dx,pvVar5));
    }
          ...
          (void *param_1,undefined4 param_2,uint param_3)
{
  ...
  else
  {
    ...
    else
    {
      ...
      reg_dx = (undefined2)((ulong)uVar11 >> 0x10);
