      ...
      if (param_3 - 0x1a0 == 0xe11)
      {
          ...
          else
          {
            puVar4 = (undefined4 *)
                     UI_SubDialog_Type8DDC_ctor_VarArgs_Logic_8520
                               (local_1a,reg_dx,g_ParentHWND,0x30,0x2,0x57b,0x57c);
          }
        ...
        if (0x0 < *(int *)((int)this_ptr + 0x92))
        {
          ...
          else
          {
            puVar4 = (undefined4 *)
                     UI_SubDialog_Type8DDC_ctor_VarArgs_Logic_8520
                               (local_1a,reg_dx,g_ParentHWND,0x21,0x2,0x57b,0x57d);
          }
          local_a = (undefined4 *)CONCAT22(uVar7,puVar4);
        ...
        reg_dx = (uint)((ulong)local_16[0x0] >> 0x10);
        local_c = 0x1a0;
        do
        {
