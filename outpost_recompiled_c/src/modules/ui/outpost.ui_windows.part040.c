...
/* Win16 far-pointer segment halves / thunk globals (1050:5bca, 5bcc, 5bce) */
u16 g_UIMainWindow_Seg;          /* segment half of p_UIMainWindow, 1050:5bca */
undefined *g_WndProc1_Thunk;     /* MakeProcInstance16 result near ptr, 1050:5bcc */
undefined *g_WndProc1_Thunk_Seg; /* MakeProcInstance16 result seg half, 1050:5bce */
...
u16 * __stdcall16far UI_Main_Window_ctor_init_cf6c(u16 *param_1)
{
  ...
  void *pvVar3;
  undefined *puVar4;
  /* undefined4 in_stack_0000fff8; -- dead Win16 stack spill, removed (flat model) */
  void *FARPROC16_func;
  ...
  *param_1 = 0xd23e;
  puVar1[0x1] = 0x1038;
  FARPROC16_func =
       (void *)0x1038; /* CONCAT22(dead_stack_seg, 0x1038) -> flat CS:1038 */
  p_UIMainWindow = (undefined *)puVar1;
  PTR_DAT_1050_0000_1050_5bca = puVar2;
  g_UIMainWindow_Seg = (u16)(uintptr_t)puVar2; /* segment half of p_UIMainWindow, 1050:5bca */
  pvVar3 = MakeProcInstance16((HANDLE16)g_hInstance,FARPROC16_func);
  puVar1[0x2] = (u16)pvVar3;
  puVar1[0x3] = (u16)((ulong)pvVar3 >> 0x10);
  puVar4 = MakeProcInstance16((HANDLE16)g_hInstance,
                              (void *)0x1038); /* CONCAT22(seg_of_FARPROC16,0x1038) -> flat */
  g_WndProc1_Thunk = puVar4;     /* MakeProcInstance16 result near ptr, 1050:5bcc */
  PTR_DAT_1050_0000_1050_5bcc = (undefined *)puVar4;
  g_WndProc1_Thunk_Seg = (undefined *)((ulong)puVar4 >> 0x10); /* 1050:5bce */
...
UI_Window_Property_Event_Handler_d118(undefined4 param_1,ulong param_2,HWND16 param_3)
{
  ...
  hwnd = 0x1050;
  HVar4 = GetProp16((char *)CONCAT22(reg_ax,(char *)s_thisHi_1050_5bf3),param_3);
  puVar5 = (undefined4 *)
           GetProp16((char *)CONCAT22(reg_ax,(char *)s_thisLo_1050_5bec),param_3);
  local_6 = (undefined4 *)CONCAT22(HVar4,puVar5);
  if (param_2._2_2_ == 0x30)
  {
    if ((HANDLE16)param_2 != 0x0)
    {
      SetProp16((HANDLE16)param_2,(void *)CONCAT22(param_3,reg_ax),hwnd);
    }
  }
  else
  {
    if (param_2 < 0x310000)
    {
      ...
      if (cVar3 == '\x02')
      {
        ...
        HVar4 = GetProp16((char *)CONCAT22(reg_ax,(char *)s_hfont_1050_5bfa),param_3);
        if (HVar4 != 0x0)
        {
          DeleteObject16(HVar4);
          RemoveProp16((char *)CONCAT22(reg_ax,(char *)s_hfont_1050_5c00),param_3);
        }
        return 0x1;
      }
      if (cVar3 == '\x06')
      ...
      local_a += 0x1)
  {
    ...
    else
    {
      reg_dx = UI_Complex_Control_ctor
                        (pvVar1,reg_dx,0x1,local_14,local_16,0x104,0x103,0x102,
                         *(undefined2 *)(iVar3 + 0x5c10),
                         *(undefined2 *)((int)this_ptr + 0x6));
    }
    _local_8 = (void *)CONCAT22(reg_dx,pvVar1);
...
LAB_1038_d490:
  ...
  case 0x14a:
    ...
    pcVar4 = Resource_Manager_LoadString_to_Internal_Buffer
                       ((int)_p_GlobalResourceManager,
                        (int)((ulong)_p_GlobalResourceManager >> 0x10),0x649);
    pvVar5 = SendDlgItemMessage16
                       ((HWND16)pcVar4,reg_dx,uVar8,uVar9,CONCAT22(enable,uVar10));
    reg_dx = (short)((ulong)pvVar5 >> 0x10);
    break;
  case 0x14b:
  ...
  if ((uStack_6._2_2_ != 0x0) && ((int)uStack_6 != 0x0))
  {
    ...
    if (BVar3 != 0x0)
    {
      ...
      SendDlgItemMessage16((HWND16)pcVar4,reg_dx,uVar8,uVar9,CONCAT22(uVar10,uVar11));
    }
  }
  if (uStack_8 != 0x0)
  {
...
void __stdcall16far UI_Colony_Summary_Dialog_Initialize_and_Layout_d8ae(void *param_1)
{
  ...
  *(undefined2 *)((int)this_ptr + 0x98) = reg_dx;
  for (local_a = 0x1; local_a <= local_8; local_a += 0x1)
  {
    ...
    {
      reg_dx = UI_Complex_Control_ctor
                        (pvVar3,reg_dx,0x0,local_24,local_26,0x101,0x100,0xff,
      ...
      *(undefined2 *)(iVar4 + local_a * 0x4 + 0x2) = reg_dx;
    }
    uVar5 = (undefined2)((ulong)*(undefined4 *)((int)this_ptr + 0x96) >> 0x10);
    iVar4 = (int)*(undefined4 *)((int)this_ptr + 0x96);
...
LAB_1038_dac3:
    ...
    if (uVar4 != 0x0)
    {
      ...
      puVar3 = (undefined4 *)
               UI_SubDialog_Type8DDC_ctor_VarArgs_Logic_8520
                         (pvVar2,reg_dx,*(undefined2 *)((int)param_1 + 0x6),0x0,0x2,0x634
                          ,iStack_4);
      goto LAB_1038_dc37;
    }
  }
  else
  {
    ...
    if (uVar4 != 0x0)
    {
      ...
      puVar3 = (undefined4 *)
               UI_SubDialog_Type8DDC_ctor_VarArgs_Logic_8520
                         (pvVar2,reg_dx,*(undefined2 *)((int)param_1 + 0x6),0x0,0x3,0x634
                          ,iStack_4,0x0);
      goto LAB_1038_dc37;
    }
  }
