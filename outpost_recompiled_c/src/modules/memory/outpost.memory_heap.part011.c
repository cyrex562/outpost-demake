...
LAB_1030_0adf:
    ...
    case 0x6d:
      ...
      if (reg_dx != 0x0 || pvVar1 != NULL)
      {
        pvVar2 = UI_Build_Item_Type56_ctor_with_Params_d3a4
                           ((void *)CONCAT22(reg_dx,pvVar1),param_3,param_4,param_6);
        return pvVar2;
      }
      break;
    case 0x35:
    ...
    case 0x37:
      pvVar1 = allocate_memory(CONCAT22(in_stack_0000fff4,0x26));
      if (reg_dx != 0x0 || pvVar1 != NULL) goto LAB_1030_0adf;
      break;
    case 0x38:
    case 0x39:
