...
void * __stdcall16far UI_Sorted_Linked_List_Manager_ctor_init_d59c(astruct_314 *param_1)
{
  ...
  *(undefined4 *)param_1 = *(undefined4 *)_p_SimulatorGlobalState;
  ...
  {
    construct_object_with_vtable(paVar1,reg_dx);
    *(undefined2 *)&((astruct_491 *)CONCAT22(reg_dx,paVar1))->field0_0x0 = 0xd804;
    *(undefined2 *)((int)&paVar1->field0_0x0 + 0x2) = 0x1028;
    uVar4->field4_0x4 = (u16 *)CONCAT22(reg_dx,paVar1);
  }
  ...
  *(uint *)(this_ptr + 0x15) = reg_dx;
  ...
  else
  {
    puVar3 = UI_Managed_List_Base_ctor_init_11aa
                       ((void *)CONCAT22(reg_dx,pvVar2),(void *)0x5,(void *)0x15);
