...
LAB_1010_2126:
    ...
    {
      puVar4 = Resource_Category1_Object_ctor(pvVar3,(int)reg_dx,id);
    }
    break;
  case 0x2:
    ...
    puVar4 = Configuration_Manager_ctor_init_6312_Logic(pvVar3,(int)reg_dx,id);
    break;
  case 0x3:
    pvVar3 = allocate_memory(CONCAT22(unaff_SI,0x53c));
    uVar5 = (uint)reg_dx | (uint)pvVar3;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    puVar4 = Simulator_Event_Dispatch_Table_Object_ctor(pvVar3,(int)reg_dx,id);
    break;
  case 0x4:
    pvVar3 = allocate_memory(CONCAT22(unaff_SI,0x18a));
    if (reg_dx == NULL && pvVar3 == NULL) goto LAB_1010_2126;
    puVar9 = (undefined4 *)
             UI_Ship_View_Controller_ctor_init_32D8_Logic
                       ((long)CONCAT22(reg_dx,pvVar3),id);
  ...
  case 0x5:
    ...
    uVar5 = (uint)reg_dx | (uint)pvVar3;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    puVar4 = UI_Element_Subclass_ctor_EB1A(pvVar3,(int)reg_dx,id);
    break;
  case 0x6:
    pvVar3 = allocate_memory(CONCAT22(unaff_SI,0x58));
    if (reg_dx == NULL && pvVar3 == NULL) goto LAB_1010_2126;
    puVar9 = (undefined4 *)
             UI_Navigation_Manager_ctor_init_1FB0_Logic((long)CONCAT22(reg_dx,pvVar3),id)
    ;
    uVar5 = (uint)((ulong)puVar9 >> 0x10);
    puVar4 = (undefined4 *)puVar9;
    break;
  case 0x7:
    ...
    uVar5 = (uint)reg_dx | (uint)pvVar3;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    puVar4 = Resource_Category2_Object_ctor(pvVar3,(int)reg_dx,id);
    break;
  case 0x8:
    pvVar3 = allocate_memory(CONCAT22(unaff_SI,0x20));
    uVar5 = (uint)reg_dx | (uint)pvVar3;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    puVar4 = UI_Object_Subclass_ctor_A1C8(pvVar3,(int)reg_dx,id);
    break;
  case 0x9:
    pvVar3 = allocate_memory(CONCAT22(unaff_SI,0x26));
    uVar5 = (uint)reg_dx | (uint)pvVar3;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    puVar4 = Resource_Category_Object_ctor_66F0(pvVar3,(int)reg_dx,id);
    break;
  case 0xa:
    pvVar3 = allocate_memory(CONCAT22(unaff_SI,0x1c));
    uVar5 = (uint)reg_dx | (uint)pvVar3;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    puVar4 = UI_Special_Manager_Subclass_ctor_init_F0C(pvVar3,(int)reg_dx,id);
    break;
  case 0xb:
    pvVar3 = allocate_memory(CONCAT22(unaff_SI,0x1c));
    uVar5 = (uint)reg_dx | (uint)pvVar3;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    puVar4 = UI_Special_Dialog_ctor_init(pvVar3,(int)reg_dx,id);
    break;
  case 0xc:
  case 0xd:
  case 0xe:
  ...
  case 0x25:
    ...
    uVar5 = (uint)reg_dx | (uint)puVar4;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    Build_Site_Object_ctor((long)CONCAT22(reg_dx,puVar4),id,unaff_SI);
    break;
  case 0x26:
    puVar4 = allocate_memory(CONCAT22(unaff_SI,0x1c));
    uVar5 = (uint)reg_dx | (uint)puVar4;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    UI_Special_Dialog_Subclass_ctor_init(puVar4,(int)reg_dx,id);
    break;
  case 0x27:
    pvVar3 = allocate_memory(CONCAT22(unaff_SI,0x58));
    uVar5 = (uint)reg_dx | (uint)pvVar3;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    puVar4 = UI_Manager_ctor(pvVar3,reg_dx,id);
    break;
  case 0x28:
    pvVar3 = allocate_memory(CONCAT22(unaff_SI,0x2c));
    uVar5 = (uint)reg_dx | (uint)pvVar3;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    puVar4 = UI_Option_Selection_Dialog_ctor(pvVar3,(int)reg_dx,id);
    break;
  case 0x29:
  ...
  case 0x2a:
    ...
    uVar5 = (uint)reg_dx | (uint)puVar4;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    UI_Special_Dialog_Subclass_ctor_init_5099(puVar4,(int)reg_dx,id);
    break;
  case 0x2b:
    pvVar3 = allocate_memory(CONCAT22(unaff_SI,0x1a));
    uVar5 = (uint)reg_dx | (uint)pvVar3;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    puVar4 = UI_Event_List_Manager_ctor(pvVar3,(int)reg_dx,id);
    break;
  case 0x2c:
    pvVar3 = allocate_memory(CONCAT22(unaff_SI,0x10));
    uVar5 = (uint)reg_dx | (uint)pvVar3;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    puVar4 = UI_Element_Subclass_ctor_EC00(pvVar3,(int)reg_dx,id);
    break;
  case 0x2d:
    pvVar3 = allocate_memory(CONCAT22(unaff_SI,0x80));
    uVar5 = (uint)reg_dx | (uint)pvVar3;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    puVar4 = UI_Complex_Dialog_ctor_4A46(pvVar3,(int)reg_dx);
    break;
  case 0x2e:
  ...
  case 0x2f:
    ...
    if (reg_dx == NULL && pvVar3 == NULL) goto LAB_1010_2126;
    puVar9 = (undefined4 *)
             Simulator_Object_Subclass_ctor_0558((long)CONCAT22(reg_dx,pvVar3));
    uVar5 = (uint)((ulong)puVar9 >> 0x10);
    puVar4 = (undefined4 *)puVar9;
    break;
  case 0x30:
    ...
    uVar5 = (uint)reg_dx | (uint)pvVar3;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    puVar4 = String_Wrapper_Object_ctor_37C4(pvVar3,(int)reg_dx,id);
    break;
  case 0x31:
    uVar8 = 0x1000;
...
LAB_1010_2680:
    ...
    {
      puVar4 = UI_Window_Subclass_ctor_9566(pvVar3,(int)reg_dx,id);
    }
    goto LAB_1010_2683;
  case 0x32:
    pvVar3 = allocate_memory(CONCAT22(unaff_SI,0x26));
    uVar5 = (uint)reg_dx | (uint)pvVar3;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    puVar4 = Resource_Summary_Manager_ctor_init_7E28_Logic(pvVar3,(int)reg_dx,id);
    break;
  case 0x33:
    pvVar3 = allocate_memory(CONCAT22(unaff_SI,0x72));
    uVar5 = (uint)reg_dx | (uint)pvVar3;
...
LAB_1010_25b8:
    ...
    {
      puVar4 = UI_Report_List_Manager_ctor_init_1B2A_Logic(pvVar3,(int)reg_dx,id);
    }
    goto LAB_1010_25bb;
  case 0x34:
    pvVar3 = allocate_memory(CONCAT22(unaff_SI,0x72));
    ...
    puVar4 = UI_Report_List_Manager_ctor_init_1D04_Logic(pvVar3,(int)reg_dx,id);
LAB_1010_25bb:
  ...
  case 0x35:
    ...
    uVar5 = (uint)reg_dx | (uint)pvVar3;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    puVar4 = Simulator_Settings_Object_ctor_init_6AAC_Logic(pvVar3,(int)reg_dx,id);
    break;
  case 0x36:
    pvVar3 = allocate_memory(CONCAT22(unaff_SI,0x10));
    uVar5 = (uint)reg_dx | (uint)pvVar3;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    puVar4 = UI_Element_Subclass_ctor_D98E(pvVar3,(int)reg_dx,id);
    break;
  case 0x37:
    pvVar3 = allocate_memory(CONCAT22(unaff_SI,0x420));
    uVar5 = (uint)reg_dx | (uint)pvVar3;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    puVar4 = UI_Specialized_Manager_ctor(pvVar3,(int)reg_dx,id);
    break;
  default:
    goto switchD_1010_2765_caseD_38;
  case 0x39:
    ...
    uVar5 = (uint)reg_dx | (uint)pvVar3;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    puVar4 = UI_Colony_Morale_Dialog_ctor(pvVar3,(int)reg_dx,id);
    break;
  case 0x3a:
    pvVar3 = allocate_memory(CONCAT22(unaff_SI,0xc));
    uVar5 = (uint)reg_dx | (uint)pvVar3;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    puVar4 = UI_Element_Subclass_ctor_D780(pvVar3,(int)reg_dx,id);
    break;
  case 0x3b:
    pvVar3 = allocate_memory(CONCAT22(unaff_SI,0x22));
    uVar5 = (uint)reg_dx | (uint)pvVar3;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    puVar4 = UI_Relationship_Manager_ctor(pvVar3,(int)reg_dx,id);
    break;
  case 0x3c:
    ...
    puVar9 = (undefined4 *)
             UI_Trade_Manager_ctor_init_470C_Logic
                       ((long)CONCAT22(reg_dx,pvVar3),id,unaff_SI);
    uVar5 = (uint)((ulong)puVar9 >> 0x10);
    puVar4 = (undefined4 *)puVar9;
    break;
  case 0x3d:
    ...
    uVar5 = (uint)reg_dx | (uint)pvVar3;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    puVar4 = UI_Component_Subclass_ctor_8EE2(pvVar3,(int)reg_dx,id);
    break;
  case 0x3e:
    pvVar3 = allocate_memory(CONCAT22(unaff_SI,0x18));
    if (reg_dx == NULL && pvVar3 == NULL) goto LAB_1010_2126;
    puVar9 = (undefined4 *)Build_Site_List_Item_ctor_init((long)CONCAT22(reg_dx,pvVar3));
    uVar5 = (uint)((ulong)puVar9 >> 0x10);
    puVar4 = (undefined4 *)puVar9;
    break;
  case 0x3f:
    ...
    uVar5 = (uint)reg_dx | (uint)pvVar3;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    puVar4 = UI_Element_Subclass_ctor_CA4A(pvVar3,(int)reg_dx,id);
    break;
  case 0x40:
    pvVar3 = allocate_memory(CONCAT22(unaff_SI,0x24));
    uVar5 = (uint)reg_dx | (uint)pvVar3;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    puVar4 = UI_Element_Subclass_ctor_BDCC(pvVar3,(int)reg_dx,id);
    break;
  case 0x41:
    pvVar3 = allocate_memory(CONCAT22(unaff_SI,0x60));
    uVar5 = (uint)reg_dx | (uint)pvVar3;
    ...
    uVar8 = 0x1008;
    puVar4 = UI_Subclass_EF9C_ctor(pvVar3,(int)reg_dx,id);
LAB_1010_2683:
  ...
  case 0x42:
    ...
    uVar5 = (uint)reg_dx | (uint)pvVar3;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    puVar4 = UI_Element_Subclass_ctor_EC62(pvVar3,(int)reg_dx,id);
    break;
  case 0x43:
    pvVar3 = allocate_memory(CONCAT22(unaff_SI,0x12));
    uVar5 = (uint)reg_dx | (uint)pvVar3;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    puVar4 = UI_Subclass_2CC2_ctor(pvVar3,(int)reg_dx,id);
    break;
  case 0x45:
    pvVar3 = allocate_memory(CONCAT22(unaff_SI,0xe));
    uVar5 = (uint)reg_dx | (uint)pvVar3;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    puVar4 = Game_Settings_Manager_ctor(pvVar3,(int)reg_dx,id);
    break;
  case 0x46:
    pvVar3 = allocate_memory(CONCAT22(unaff_SI,0x1a));
    uVar5 = (uint)reg_dx | (uint)pvVar3;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    puVar4 = String_Wrapper_Subclass_ctor_53F4(pvVar3,(int)reg_dx,id);
    break;
  case 0x47:
    pvVar3 = allocate_memory(CONCAT22(unaff_SI,0xe));
    if (reg_dx == NULL && pvVar3 == NULL) goto LAB_1010_2126;
    puVar9 = (undefined4 *)UI_Building_Manager_ctor_init(pvVar3,(int)reg_dx,id);
    uVar5 = (uint)((ulong)puVar9 >> 0x10);
    puVar4 = (undefined4 *)puVar9;
    break;
  case 0x48:
    ...
    uVar5 = (uint)reg_dx | (uint)pvVar3;
    if (uVar5 == 0x0) goto LAB_1010_2126;
    puVar4 = Display_Adapter_Object_ctor(pvVar3,(int)reg_dx,id);
  }
  uStack_6 = (undefined4 *)CONCAT22(uVar5,puVar4);
