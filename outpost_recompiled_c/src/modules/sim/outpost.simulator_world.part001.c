...
/* Cross-module extern: g_SimulatorContext defined in outpost.ui_windows.part001.c (1050:0298) */
extern undefined4 g_SimulatorContext;
...
{
  /* in_stack_00000006: Win16 stack artifact — removed in flat model */
                // Segment:    2
                // Offset:     000060e0
                // Length:     efe0
                // Min Alloc:  efe0
...
{
  undefined4 *puVar1;
  /* iVar2: was segment half of far this-ptr — unused in flat model */
  void *pvVar3;
  int *this_ptr;
  /* unaff_CS: Win16 CS register reload after far call — removed in flat model */
  /* in_stack_00000006: Win16 stack artifact — removed in flat model */
  *_this = 0x51e;
  *(undefined2 *)((int)this + 0x2) = 0x1008;
  ...
  {
    far_noop_stub_3();
    /* unaff_CS = 0x1000; — Win16 CS reload, flat model: omit */
    free_if_not_null(pvVar3);
  }
  g_SimulatorContext = 0x0; /* _PTR_DAT_1050_0000_1050_0298: cleared on destruction */
  if (_p_SimulatorGlobalState != NULL)
  {
    this_ptr = (int *)_p_SimulatorGlobalState;
    Simulator_Global_State_dtor_Internal_8210(this_ptr);
    /* unaff_CS = 0x1000; — flat model: omit */
  ...
  {
    /* unaff_CS, segment half dropped: flat model far call */
    (*(code *)*(undefined2 *)(undefined2 *)*_p_UIMainWindow)
              ((undefined4 *)_p_UIMainWindow, 0x1);
  }
  if (_p_UIPanelContainer != NULL)
  {
    /* unaff_CS, segment half dropped: flat model far call */
    (*(code *)*(undefined2 *)(undefined2 *)*_p_UIPanelContainer)
              ((undefined4 *)_p_UIPanelContainer, 0x1);
  }
  puVar1 = (undefined4 *)*(int *)((int)this + 0x4);
  /* iVar2 was segment half of far ptr — not needed in flat model */
  if (puVar1 != NULL)
  {
    /* unaff_CS, iVar2 segment dropped: flat model far call */
    (*(code *)*(undefined2 *)(undefined2 *)*puVar1)(puVar1, 0x1);
  }
...
void __stdcall16far Simulator_init_or_exit_on_fail(void)
{
  ...
  if (_p_SimulatorGlobalState == NULL)
  {
    ...
    {
      Simulator_Global_State_ctor_init_8128((void *)CONCAT22(reg_dx,pvVar1));
    }
    if (_p_SimulatorGlobalState == NULL)
    {
...
void __stdcall16far Simulator_allocate_and_init_internal(void)
{
  ...
  if (reg_dx != 0x0 || pvStack_6 != NULL)
  {
    Simulator_Global_State_ctor_init_8128((void *)CONCAT22(reg_dx,pvStack_6));
  }
  if (_p_SimulatorGlobalState == NULL)
  {
