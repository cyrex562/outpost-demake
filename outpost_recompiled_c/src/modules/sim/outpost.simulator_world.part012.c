...
Resource_Manager_Composite_SubBitmap_Logic(void *this,void *container,int index)
{
  ...
  if (*(long *)((int)this + 0x67c) != 0x0)
  {
    ...
    _pvStack_8 = (void *)CONCAT22(reg_dx,pvVar2);
    ...
    _pvStack_14 = (void *)CONCAT22(reg_dx,pvVar2);
    ...
    {
      pvVar2 = Bitmap_Object_Subclass_ctor_with_alloc(pvVar2,reg_dx,(int)uStack_18);
    }
  ...
  *(undefined2 *)((int)this + 0x2) = 0x1010;
  ...
  else
  {
    pvVar2 = UI_Production_Item_Base_ctor_init_1cd8
                       ((void *)CONCAT22(reg_dx,pvVar1),(void *)0x5,(void *)0x5);
