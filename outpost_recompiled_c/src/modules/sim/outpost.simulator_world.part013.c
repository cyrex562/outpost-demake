...
LAB_1010_adee:
  if (uStack_6 == NULL)
  {
    ...
    uStack_6 = (char *)((ulong)reg_dx << 0x10);
  }
          ...
          (undefined2 param_1,undefined2 param_2,byte *param_3,int param_4)
{
  ...
  if (param_4 == 0x6)
  {
    for (uStack_4 = 0x0; (int)uStack_4 < 0x15; uStack_4 += 0x1)
    {
      ...
      iVar2 = strcmp_case_sensitive(param_3,(char *)CONCAT22(reg_dx,pcVar1));
      if (iVar2 == 0x0)
      {
        return uStack_4;
      }
...
void __stdcall16far Resource_Manager_Bulk_Load_Entity_Icons_Logic(long param_1)
{
  ...
  uStack_6 = (int *)CONCAT22(reg_dx,piVar2);
          ...
          (undefined2 param_1,undefined2 param_2,undefined1 *param_3,void *param_4)
{
  ...
  if (param_3 == NULL)
  {
    ...
    uStack_6 = (undefined1 *)CONCAT22(reg_dx,puVar1);
  }
          ...
          (void *param_1,undefined2 param_2,u16 param_3,undefined4 param_4)
{
  ...
  {
    puVar4 = Helper_ZeroFill_24Bytes_a598((void *)CONCAT22(reg_dx,pvVar1));
