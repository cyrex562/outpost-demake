...
u16 __stdcall16far UI_SubDialog_TypeA0B6_Draw_Entity_Summary_9ffa(void *this_ptr)
{
  ...
  uStack_8 = (undefined4 *)CONCAT22(reg_dx,puVar1);
  iVar1 = (astruct_113 *)(astruct_113 *)*uStack_8;
  (*(code *)iVar1->field6_0x8)(0x1010,puVar1,reg_dx,&local_4);
...
UI_SubDialog_Type237E_ctor_init_1f5a(void *this_ptr,ushort parent_hwnd)
{
  ...
  *(undefined2 *)((int)this_ptr + 0x90) = reg_dx;
...
undefined2 __stdcall16far UI_SubDialog_Type3D5E_OnPaint_Logic_3d5e(undefined4 param_1)
{
  ...
  puVar1 = Resource_Manager_Load_Resource_Object_Logic
                     ((void *)_p_GlobalResourceManager,
                      (int)((ulong)_p_GlobalResourceManager >> 0x10));
  local_8 = (undefined4 *)CONCAT22(reg_dx,puVar1);
  iVar2 = (int)*local_8;
  (*(code *)*(undefined2 *)(iVar2 + 0x8))(0x1010,puVar1,reg_dx,&local_4);
...
undefined2 __stdcall16far UI_SubDialog_Type5A06_OnPaint_Logic_5a06(undefined4 param_1)
{
  ...
  if (*(int *)(iVar13 + 0x98) != 0x0)
  {
    puVar6 = Resource_Manager_Load_Resource_Object_Logic
                       ((void *)_p_GlobalResourceManager,
                        (int)((ulong)_p_GlobalResourceManager >> 0x10));
    local_36 = (undefined4 *)CONCAT22(reg_dx,puVar6);
    iVar11 = reg_dx;
    ...
    if (iVar11 == 0x0 && pvVar7 == NULL)
    {
      ...
      if (local_36 != NULL)
      {
        if (local_36 != NULL)
        {
          (*(code *)*(undefined2 *)(undefined2 *)*local_36)(0x1008,puVar6,reg_dx,0x1);
          uVar15 = extraout_DX;
        }
      }
      puVar6 = Resource_Manager_Load_Resource_Object_Logic
  ...
  if (local_36 != NULL)
  {
    if (local_36 != NULL)
    {
      ...
      reg_dx = extraout_DX_01;
    }
  }
  puVar8 = Resource_Manager_Load_Resource_Object_Logic
                     ((void *)_p_GlobalResourceManager,
                      (int)((ulong)_p_GlobalResourceManager >> 0x10));
  local_36 = (undefined4 *)CONCAT22(reg_dx,puVar8);
  pHVar17 = &local_2c;
  uVar12 = 0x4;
  uVar19 = 0xd;
  ...
  if (local_36 != NULL)
  {
    if (local_36 != NULL)
    {
      ...
      (*(code *)*puVar3)(0x1538,puVar8,reg_dx,0x1,puVar6,iVar11,iVar10,uVar12,uVar19,
                         pHVar17);
