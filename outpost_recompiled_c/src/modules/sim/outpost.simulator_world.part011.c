...
u16 g_GlobalResourceManager_Seg; /* Segment half of p_GlobalResourceManager far ptr (1050:14ce) */
...
u32 * __stdcall16far Global_Resource_Manager_ctor_init_1010_7e40(u32 *param_1)
{
  ...
  *(undefined1 *)((int)puVar1 + 0xa82) = 0x0;
  ...
  g_GlobalResourceManager_Seg = (u16)(uintptr_t)value; /* PTR_DAT_1050_0000_1050_14ce: segment half of p_GlobalResourceManager (1050:14ce) */
