          ...
          (astruct_153 *param_1,undefined4 *param_2)
{
  ...
  else
  {
    puVar7 = UI_Production_Item_Base_ctor_init_1cd8
                       ((void *)CONCAT22(reg_dx,pvVar2),(void *)0x5,(void *)0x5);
