          ...
          (u16 arg1,u16 arg2,u32 *src_list,u32 dest_list)
{
  ...
  uVar8 = (*(code *)*puVar4)();
  uStack_c = CONCAT22((int)reg_edx,uVar8);
  uStack_10 = 0x0;
  do
  {
    ...
    puStack_14 = (u8 *)(*(code *)*puVar4)(unaff_CS,src_list,in_stack_0000000a,
                                          ...
                                          puVar17,uVar18);
    uStack_12 = uVar13;
    reg_edx = (ulong)(uStack_12 | (uint)puStack_14);
