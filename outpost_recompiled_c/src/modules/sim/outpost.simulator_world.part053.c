...
Colony_Process_Resource_Allocation_Logic_6f5a(void *this_ptr,void *colony_ptr)
{
  ...
  if (uVar2->field13_0xe == NULL)
  {
    ...
    uStack_14 = (astruct_137 *)CONCAT22(reg_dx,paVar1);
    if (reg_dx == 0x0 && paVar1 == NULL)
    {
      paStack_10 = NULL;
    }
    else
      ...
      *(int *)&uVar2->field13_0xe == 0x0)
  {
    if (uVar2->field12_0xc == 0x0)
    {
      if (uVar2->field14_0x12 == 0x0)
      {
        ...
        uStack_14 = (undefined2 *)CONCAT22(reg_dx,puVar5);
        if (reg_dx == 0x0 && puVar5 == NULL)
        {
          puStack_28 = NULL;
        }
        else
  ...
  else
  {
    ...
    for (uStack_c = 0x0; uStack_c < uStack_4; uStack_c += 0x1)
    {
      ...
      if (local_a != 0x0)
      {
        ...
        reg_dx = (int)((ulong)uVar1 * (ulong)(uint)puVar5[0x5] >> 0x10);
