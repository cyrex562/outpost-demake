...
typedef struct Resource_Category_66F0 Resource_Category_66F0, *PResource_Category_66F0;

struct Resource_Category_66F0 {
};

typedef struct Resource_Category2_Object Resource_Category2_Object, *PResource_Category2_Object;

struct Resource_Category2_Object {
};

typedef struct Resource_Summary_Manager Resource_Summary_Manager, *PResource_Summary_Manager;

struct Resource_Summary_Manager {
};

typedef struct Probabilistic_Value_Entry Probabilistic_Value_Entry, *PProbabilistic_Value_Entry;

struct Probabilistic_Value_Entry {
    uint divisor;
...
typedef struct Resource_Category1_Object Resource_Category1_Object, *PResource_Category1_Object;

struct Resource_Category1_Object {
};
...
typedef struct Bitmap_Region_Entry Bitmap_Region_Entry, *PBitmap_Region_Entry;

struct Bitmap_Region_Entry {
};

typedef struct Slider_Resource_39 Slider_Resource_39, *PSlider_Resource_39;

struct Slider_Resource_39 {
    undefined field0_0x0;
    undefined field1_0x1;
    undefined field2_0x2;
    undefined field3_0x3;
...
typedef struct Collection_Object_Base Collection_Object_Base, *PCollection_Object_Base;

struct Collection_Object_Base {
};

typedef struct Collection_958E Collection_958E, *PCollection_958E;

struct Collection_958E {
};

typedef struct Collection_Object_3B3E Collection_Object_3B3E, *PCollection_Object_3B3E;
...
typedef struct Resource_Change_Entry Resource_Change_Entry, *PResource_Change_Entry;
